...
LAUNCHER_PULL_UP_SUPPORT = TRUE    #表盘界面上拉
...
MAINLCD_DEV_SIZE_128X128 = TRUE

W217_W18_DRV_LCD_7789P3_240X284 = FALSE

W217_W18_DRV_TP_6133_SERIES = FALSE
W217_LT36_128_TP_6133_SERIES = TRUE

W217_W18_DRV_CAMERA_GC6133 = FALSE
...
MAINMENU_STYLE_SUPPORT = FALSE   #菜单风格切换
#主菜单默认圆弧样式
MAINMENU_STYLE_DEFAULT_ROUND_CIRCULAR = FALSE
...
#############至少一个为TRUE##############
WATCH_PANEL_SPACE_SHIP_SUPPORT = TRUE     #宇宙飞船数字表盘
WATCH_PANEL_DOLPHIN_SUPPORT = TRUE        #海豚
WATCH_PANEL_ASTRONAUT_SUPPORT = TRUE      #太空人
WATCH_PANEL_PANDA_SUPPORT = TRUE          #熊猫
WATCH_PANEL_BLACK_GREEN_SUPPORT = FALSE    #黑绿色模拟时钟
WATCH_PANEL_DEER_SUPPORT = TRUE           #小鹿
WATCH_PANEL_SPACE_STATION_SUPPORT = TRUE  #空间站宇航员
#############至少一个为TRUE##############
...
MMI_RES_DIR = mmi_res_128x128                           ### resource directory  MMI_RES_DIR_mmi_res_240x240_child_circular
                                                     # Option1:mmi_res_128x128
