...
PUBLIC void CHIP_Enable7sRstMode_ALL(void)
{
        ...
        por_7s_ctrl.b.pbint_7s_rst_mode = 0;            //BIT_0:software/hardware reset;
        por_7s_ctrl.b.pbint_7s_rst_disable = 0;         //BIT_1:enable 7s reset function;
        por_7s_ctrl.b.pbint_7s_auto_on_en = 0;        //BIT_2:RTC register PBINT_7S_AUTO_ON_EN;
        por_7s_ctrl.b.ext_rstn_mode = 0;                 //BIT_3:EXT_RSTN PIN function mode when 1key 7S reset;
        por_7s_ctrl.b.pbint_7s_rst_threshold = 0xf;      //BIT_4~7:The power key long pressing time threshold;
    ...
    ANA_REG_OR(ANA_POR_7S_CTRL, (0xF)<<4); // 0x09 modifed by bao for 16s resest
