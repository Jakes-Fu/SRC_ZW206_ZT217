...
/*|logic_num|phy_num|base_addr*/
	...
	{DMA_ID_RX_UART3,3,REG_ACCESS_ADDRESS(REG_AON_IFC_BASE)},
       {DMA_ID_RX_CAMERA,0,REG_ACCESS_ADDRESS(REG_AP_IFC_BASE)},// 展锐修改,优化BF20A6摄像头 横纹.. wuxx add. modify ifc_hal.c and ifc_manager_cfg.c// {DMA_ID_TX_DBG_UART,4,REG_ACCESS_ADDRESS(REG_AON_IFC_BASE)},
	...
	{DMA_ID_TX_UART4,9,REG_ACCESS_ADDRESS(REG_AP_IFC_BASE)}, // 展锐修改,优化BF20A6摄像头 横纹.. wuxx add. modify ifc_hal.c and ifc_manager_cfg.c// {DMA_ID_RX_CAMERA,9,REG_ACCESS_ADDRESS(REG_AP_IFC_BASE)},
