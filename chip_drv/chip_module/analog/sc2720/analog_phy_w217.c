...
#else
    {ANA_DEV_ID_LCM_BL,                     0x0C,     0,      NULL,                        ANA_SW_INDEX_MAX,      _ANA_SetLCMBackLight}, //0x12 modified by bao 最大亮度600nit
    {ANA_DEV_ID_LCM_BRIGHTNESS,      0x0C,     0,     NULL,                  ANA_SW_INDEX_MAX,       _ANA_SetLCMBrightness}, /*0x12 lint !e605 modified by bao 最大亮度600nit*/
#endif
#if defined(POP_MDY_SUPPORT)
...
PUBLIC void ANA_PHY_SetCodecTpFunc(uint32 value)
{
	...
	else
	{
		...
		//音频常开，不需要关闭 
		//GPIO_SetValue(11, 0);		//AUDIO_PA_EN
        //GPIO_SetValue (27, 1); // CODEC_1V8_EN 
