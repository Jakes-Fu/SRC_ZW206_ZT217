...
typedef enum
{
    ...
    CHR_CHARGE_OVERTEMP,       // the charge fault, maybe the voltage of charge is too high.
    CHR_CHARGE_LOWTEMP,       // the charge fault, maybe the voltage of charge is too low.
    CHR_CHARGE_HOTTEMP,       // the charge fault, maybe the voltage of charge is too hot.
    CHR_MSG_MAX_NUM
