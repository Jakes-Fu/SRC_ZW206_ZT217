...
LOCAL void ST7789v2_Init(void)
{
    ...
    LCD_DataWrite_ST7789v2( 0x74);   

    LCD_CtrlWrite_ST7789v2(0xBB);     
    LCD_DataWrite_ST7789v2( 0x3D);   //Vcom=1.625V

    LCD_CtrlWrite_ST7789v2(0xC2);     
    LCD_DataWrite_ST7789v2( 0x01);   

    LCD_CtrlWrite_ST7789v2(0xC3);     
    LCD_DataWrite_ST7789v2( 0x19);   //GVDD=4.8V 

    LCD_CtrlWrite_ST7789v2(0xC4);     
    LCD_DataWrite_ST7789v2( 0x20);   //VDV, 0x20:0v

    LCD_CtrlWrite_ST7789v2(0xC6);     
    LCD_DataWrite_ST7789v2( 0x0F);   //0x0F:60Hz        	
    ...
    LCD_CtrlWrite_ST7789v2(0xE9);     
    LCD_DataWrite_ST7789v2( 0x04);   
    LCD_DataWrite_ST7789v2( 0x07);   
    LCD_DataWrite_ST7789v2( 0x03); 
     
    LCD_CtrlWrite_ST7789v2(0xE0);     
    LCD_DataWrite_ST7789v2( 0x70);   
    LCD_DataWrite_ST7789v2( 0x04);   
    LCD_DataWrite_ST7789v2( 0x08);   
    LCD_DataWrite_ST7789v2( 0x09);   
    LCD_DataWrite_ST7789v2( 0x09);   
    LCD_DataWrite_ST7789v2( 0x05);   
    LCD_DataWrite_ST7789v2( 0x2A);   
    LCD_DataWrite_ST7789v2( 0x33);   
    LCD_DataWrite_ST7789v2( 0x41);   
    LCD_DataWrite_ST7789v2( 0x07);   
    LCD_DataWrite_ST7789v2( 0x13);   
    LCD_DataWrite_ST7789v2( 0x13);   
    LCD_DataWrite_ST7789v2( 0x29);   
...
#elif defined(DRV_LCD_7789P3_240X284)// wuxx  7789P3 -0x8181B3  240X284 for W206
hal_LcdDelay(120);                
...
LCD_CtrlWrite_ST7789v2(0xD6);     
LCD_DataWrite_ST7789v2(0xA1);   //sleep in后，gate输出为GND
...
LCD_DataWrite_ST7789v2(0x00);   //设定gate起点位置
LCD_DataWrite_ST7789v2(0x00);   //当gate没有用完时，bit4(TMG)设为0
...
#elif defined(W217_W18_DRV_LCD_7789P3_240X284)// W18 9307 240X284 FOR W18
LCD_CtrlWrite_ST7789v2(0x11);   
...
LCD_CtrlWrite_ST7789v2(0x2C);
    ...
    LCD_CtrlWrite_ST7789v2( 0xBB); //vcom, wang ge wen ,   qinxidu 
    LCD_DataWrite_ST7789v2( 0x2F);   

    LCD_CtrlWrite_ST7789v2( 0xC2);     
    LCD_DataWrite_ST7789v2( 0x01);   

    LCD_CtrlWrite_ST7789v2( 0xC3);  //vrh ,dui bi du   00 - 3f
    ...
    LCD_CtrlWrite_ST7789v2( 0xC6);     
    LCD_DataWrite_ST7789v2( 0x15);   //0x0F:60Hz     ,15:50HZ    ,1E:40HZ   	
    ...
    LCD_DataWrite_ST7789v2( 0x17);   
    LCD_DataWrite_ST7789v2( 0x1F);   
    LCD_DataWrite_ST7789v2( 0x4C);   
    LCD_DataWrite_ST7789v2( 0x53);   
    LCD_DataWrite_ST7789v2( 0x5B);   
    LCD_DataWrite_ST7789v2( 0x1A);   
    LCD_DataWrite_ST7789v2( 0x16);   
    LCD_DataWrite_ST7789v2( 0x13);   
    LCD_DataWrite_ST7789v2( 0x25);   
    LCD_DataWrite_ST7789v2( 0x28);   

    LCD_CtrlWrite_ST7789v2( 0xE1);     
    LCD_DataWrite_ST7789v2( 0xD0);   
    LCD_DataWrite_ST7789v2( 0x02);   
    LCD_DataWrite_ST7789v2( 0x0E);   
    LCD_DataWrite_ST7789v2( 0x11);   
    LCD_DataWrite_ST7789v2( 0x16);   
	...
	LCD_CtrlWrite_ST7789v2( 0x35);//open TE
    LCD_DataWrite_ST7789v2( 0x00);	
