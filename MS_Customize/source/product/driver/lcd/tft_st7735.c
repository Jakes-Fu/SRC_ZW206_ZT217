...
#define ST7735_X_OFFSET 2 //0
#define ST7735_Y_OFFSET 3 //32
...
{       
    ...
    LCD_DataWrite_ST7735(newleft>>8);
    LCD_DataWrite_ST7735(newleft);
    LCD_DataWrite_ST7735(newright>>8);
    LCD_DataWrite_ST7735(newright);

    LCD_CtrlWrite_ST7735(0x2b);   
    LCD_DataWrite_ST7735(newtop>>8);
    LCD_DataWrite_ST7735(newtop);
    LCD_DataWrite_ST7735(newbottom>>8);
    LCD_DataWrite_ST7735(newbottom);
...
LOCAL void ST7735_Init(void)
{
    ...
    LCD_CtrlWrite_ST7735(0x0011); 		
    hal_LcdDelay(300);

    LCD_CtrlWrite_ST7735(0x00b1); 		
    LCD_DataWrite_ST7735(0x0002);
    LCD_DataWrite_ST7735(0x0035);
    LCD_DataWrite_ST7735(0x0036);

    LCD_CtrlWrite_ST7735(0x00b2); 		
    LCD_DataWrite_ST7735(0x0002);
    LCD_DataWrite_ST7735(0x0035);
    LCD_DataWrite_ST7735(0x0036);

    LCD_CtrlWrite_ST7735(0x00b3); 		
    LCD_DataWrite_ST7735(0x0002);
    LCD_DataWrite_ST7735(0x0035);
    LCD_DataWrite_ST7735(0x0036);
    LCD_DataWrite_ST7735(0x0002);
    ...
    LCD_CtrlWrite_ST7735(0x00b4); 		
    LCD_DataWrite_ST7735(0x0000);

    LCD_CtrlWrite_ST7735(0x00c0); 		
    LCD_DataWrite_ST7735(0x00a2);
    LCD_DataWrite_ST7735(0x0002);
    LCD_DataWrite_ST7735(0x0084);
    
    LCD_CtrlWrite_ST7735(0x00c1); 		
    LCD_DataWrite_ST7735(0x00c5);


    LCD_CtrlWrite_ST7735(0x00c2); 		
    LCD_DataWrite_ST7735(0x000d);
    LCD_DataWrite_ST7735(0x0000);


    LCD_CtrlWrite_ST7735(0x00c3); 		
    LCD_DataWrite_ST7735(0x008a);
    LCD_DataWrite_ST7735(0x002a);



    LCD_CtrlWrite_ST7735(0x00c4); 		
    LCD_DataWrite_ST7735(0x008d);
    LCD_DataWrite_ST7735(0x00ee);

    LCD_CtrlWrite_ST7735(0x00c5); 		
    LCD_DataWrite_ST7735(0x0012);

    LCD_CtrlWrite_ST7735(0x0036); 		
    LCD_DataWrite_ST7735(0x00c8);

    LCD_CtrlWrite_ST7735(0x00e0); 		
    LCD_DataWrite_ST7735(0x0012);
    LCD_DataWrite_ST7735(0x001c);
    LCD_DataWrite_ST7735(0x0010);
    LCD_DataWrite_ST7735(0x0018);
    LCD_DataWrite_ST7735(0x0033);
    LCD_DataWrite_ST7735(0x002c);
    LCD_DataWrite_ST7735(0x0025);
    LCD_DataWrite_ST7735(0x0028);
    LCD_DataWrite_ST7735(0x0028);
    LCD_DataWrite_ST7735(0x0027);
    LCD_DataWrite_ST7735(0x002f);
    LCD_DataWrite_ST7735(0x003c);
    LCD_DataWrite_ST7735(0x0000);
    LCD_DataWrite_ST7735(0x0003);
    LCD_DataWrite_ST7735(0x0003);
    LCD_DataWrite_ST7735(0x0010);
    hal_LcdDelay(120);

    LCD_CtrlWrite_ST7735(0x00e1); 		
    LCD_DataWrite_ST7735(0x0012);
    LCD_DataWrite_ST7735(0x001c);
    LCD_DataWrite_ST7735(0x0010);
    LCD_DataWrite_ST7735(0x0018);
    LCD_DataWrite_ST7735(0x002d);
    LCD_DataWrite_ST7735(0x0028);
    LCD_DataWrite_ST7735(0x0023);
    LCD_DataWrite_ST7735(0x0028);
    LCD_DataWrite_ST7735(0x0028);
    LCD_DataWrite_ST7735(0x0026);
    LCD_DataWrite_ST7735(0x002f);
    LCD_DataWrite_ST7735(0x003b);
    LCD_DataWrite_ST7735(0x0000);
    LCD_DataWrite_ST7735(0x0003);
    LCD_DataWrite_ST7735(0x0003);
    LCD_DataWrite_ST7735(0x0010);
    ...
    LCD_CtrlWrite_ST7735(0x003a); 		
    LCD_DataWrite_ST7735(0x0005);

    LCD_CtrlWrite_ST7735(0x2a);
    LCD_DataWrite_ST7735(0x00);
    LCD_DataWrite_ST7735(0x02);
    LCD_DataWrite_ST7735(0x00);
    LCD_DataWrite_ST7735(0x81);

    LCD_CtrlWrite_ST7735(0x2b);
    LCD_DataWrite_ST7735(0x00);
    LCD_DataWrite_ST7735(0x03);
    LCD_DataWrite_ST7735(0x00);
    LCD_DataWrite_ST7735(0xa2);
