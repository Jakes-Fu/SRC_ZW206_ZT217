...
LOCAL ERR_LCD_E GC9307_Init(void)
{
	...
	hal_LcdDelay(120);
#if 0//defined(ZDT_H03W_SUPPORT)
	//------end Reset Sequence-----// 1.44
	LCD_CtrlWrite_GC9307(0xfe);
	LCD_CtrlWrite_GC9307(0xef);
	LCD_CtrlWrite_GC9307(0x36);
	...
	LCD_DataWrite_GC9307(0x97);
	LCD_DataWrite_GC9307(0x98);
	LCD_DataWrite_GC9307(0x1e);
	LCD_DataWrite_GC9307(0x25);
	LCD_DataWrite_GC9307(0xaF);
	...
	LCD_DataWrite_GC9307(0x3d);
	LCD_DataWrite_GC9307(0x92);
