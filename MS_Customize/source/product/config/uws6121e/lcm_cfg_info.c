...
LOCAL LCM_CFG_INFO_T s_main_lcm_cfg_tab[] =
{
	...
	//{ LCD_DRV_ID_JD9851, 0, ONE_DATA_LINE_LCD, ENABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_JD9851,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"JD9851"}, 
	...
	//{ LCD_DRV_ID_ST7789P3, 0, ONE_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_ST7789p3,  LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"ST7789P3"},// 7789P3
	{ LCD_DRV_ID_GC9107, 0, ONE_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_GC9107,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"GC9107"},
        #if defined(DRV_LCD_7789P3_240X284)||defined(W217_W18_DRV_LCD_7789P3_240X284)
	/*{ LCD_DRV_ID_ST7735, 0, ONE_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_ST7735,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"ST7735P3"},
        #if defined(DRV_LCD_7789P3_240X284)||defined(W217_W18_DRV_LCD_7789P3_240X284)*/
        //{ LCD_DRV_ID_ST7789P3, 0, ONE_DATA_LINE_LCD, ENABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_ST7789p3,  LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"ST7789P3"},// 7789P3
        #else
