...
LOCAL const uint16 keymap[] = {
	...
	/*				|						|						|						|						|						|						|						|                                    */
					SCI_VK_UP,	            SCI_VK_LEFT,	            SCI_VK_REWIND,	        SCI_VK_VOL_DOWN,	SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,
	/*				|						|						|						|						|						|						|						|                                     */
	/*				|						|						|						|						|						|						|						|                                     */
	/*KEYOUT2------o-----------------------o-----------------------o-----------------------o-----------------------o-----------------------o----------------------  o-----------------------o---------------------*/
	/*				|						|						|						|						|						|						|						|                                     */
					SCI_VK_DOWN,	SCI_VK_INVALID_KEY,	     SCI_VK_INVALID_KEY,	       SCI_VK_INVALID_KEY,	SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,
	/*				|						|						|						|						|						|						|						|                                     */
	/*				|						|						|						|						|						|						|						|                                      */
	/*KEYOUT3------o-----------------------o-----------------------o-----------------------o-----------------------o-----------------------o----------------------  o-----------------------o---------------------*/
	/*				|						|						|						|						|						|						|						|                                     */
					SCI_VK_INVALID_KEY,	SCI_VK_INVALID_KEY,	SCI_VK_INVALID_KEY,	SCI_VK_SHORTCUT,	SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,      SCI_VK_INVALID_KEY,
	/*				|						|						|						|						|						|						|						|                                      */
	/*				|						|						|						|						|						|						|						|                                     */
