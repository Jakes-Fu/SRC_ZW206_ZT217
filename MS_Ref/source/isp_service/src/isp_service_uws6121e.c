...
/* AGORA_PATCH start */
#define ISP_STACK_SIZE                  ((1024 * 8) + 512) // BAIDU_VIDEOCHAT_SUPPORT , baidu video need MIN ((1024 * 4) + 512)
/* AGORA_PATCH end */
...
LOCAL uint32 _ISP_ServiceCheckPreviewParam(ISP_PREVIEW_PARAM_T * param_ptr)
{
    ...
    #if defined(BAIDU_VIDEOCHAT_SUPPORT)//BAIDU_VIDEO_SIZE wuxx 20231202
    // baidu video , del it.
    #else
