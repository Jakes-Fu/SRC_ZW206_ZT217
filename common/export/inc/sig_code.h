...
#endif	    
    CHR_MSG_CHARGE_LOW_TEMPTURE_IND,       // the charge fault, maybe the voltage of charge is too high/low.
    CHR_MSG_CHARGE_HOT_TEMPTURE_IND,       // the charge fault, maybe the voltage of charge is too high/low.
...
typedef enum _ZDT_APP_SIGNAL
{
    ...
    ZDT_APP_SIGNAL_YX_RECORD_CANCEL,
    ZDT_APP_SIGNAL_YX_RECORD_FAIL,
    ZDT_APP_SIGNAL_YX_RECORD_SEND,
    ZDT_APP_SIGNAL_YX_EMOJI_SEND,
    ZDT_APP_SIGNAL_YX_EMOJI_SEND_SUCCESS,
...
#define ZYB_APP_GROUP  (0xFB)
typedef enum _ZYB_APP_SIGNAL
{
    ZYB_APP_SIGNAL_START = (( ZYB_APP_GROUP << 8 ) | 1 ) ,
    ZYBHTTP_APP_SIGNAL_HTTP_SEND,
    ZYBHTTP_APP_SIGNAL_HTTP_RESEND,
    ZYBHTTP_APP_SIGNAL_HTTP_RCV,
    ZYBHTTP_APP_SIGNAL_HTTP_SEND_OVER,
    ZYBHTTP_APP_SIGNAL_NET_INIT,
    ZYBHTTP_APP_SIGNAL_NET_RESET,
    ZYBHTTP_APP_SIGNAL_NET_OPEN,
    ZYBHTTP_APP_SIGNAL_NET_CLOSE,
    ZYBHTTP_APP_SIGNAL_PDP_ACTIVE_FAIL,
    ZYBHTTP_APP_SIGNAL_PDP_ACTIVE_SUCCESS,
    ZYBHTTP_APP_SIGNAL_PDP_CONNECT_FAIL,
    ZYBHTTP_APP_SIGNAL_HTTP_REFRESH,
    ZYBHTTP_APP_SIGNAL_HTTP_AUDIOGET,
    ZYBHTTP_APP_SIGNAL_HTTP_AUDIOPLAY,
    ZYBHTTP_APP_SIGNAL_HTTP_AUDIOSTOP,
    ZYBHTTP_APP_SIGNAL_HTTP_AUDIOSTOPDELAY,
    ZYB_APP_SIGNAL_END,
    ZYB_APP_SIGNAL_MAX = ((ZYB_APP_GROUP << 8) | SIGNAL_MAX_OFFSET)
}ZYB_APP_SIG_E;
#endif
