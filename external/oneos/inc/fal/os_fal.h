...
typedef struct os_fal_flash os_fal_flash_t;

struct fal_flash_ops
{
    int (*read_page)(os_fal_flash_t *flash, os_uint32_t page_addr, os_uint8_t *buff, os_uint32_t page_nr);
    int (*write_page)(os_fal_flash_t *flash, os_uint32_t page_addr, const os_uint8_t *buff, os_uint32_t page_nr);
    int (*erase_block)(os_fal_flash_t *flash, os_uint32_t page_addr, os_uint32_t page_nr);
};
...
struct os_fal_flash
{
    char name[OS_FAL_DEV_NAME_MAX];  /* the name of the flash */
...
// int fal_flash_register(os_fal_flash_t *flash);
// os_fal_flash_t *fal_flash_find(const char *name);
