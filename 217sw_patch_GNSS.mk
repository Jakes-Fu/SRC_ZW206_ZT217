...
SFR_SUPPORT_CMCC = TRUE                             ### DM CMCC
                                                     # Option1:TRUE support CMTT self register
                                                     # Option2:FALSE not support CMTT self register
#2h11 end

SIM_PLUG_IN_SUPPORT = HARDWARE                          ### Platform Support SIM HOT PLUGIN
                                                     # Option1:HARDWARE
                                                     # Option2:LOGIC
                                                     # Option3:NONE
...
DYNAMIC_WATCHFACE_SUPPORT = FALSE                   ###DYNAMIC WATCHFACE SUPPORT
                                                    # Option1:TRUE
                                                    # Option2:FALSE

WATCHFACE_MANAGE_SUPPORT = FALSE                     ###WATCHFACE_MANAGE support
                                                    # Option1:TRUE
                                                    # Option2:FALSE
...
LWM2M_SUPPORT_4 = TRUE
LIBLWM2M_SUPPORT = FALSE
endif