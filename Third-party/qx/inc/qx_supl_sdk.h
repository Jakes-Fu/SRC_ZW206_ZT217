...
#include "uws6121e_module_ver_extern.h"//fix redeclaration of "S8"
/**
...
#pragma pack()
    ...
    /**
     * Setting QXSUPL SDK Agent url.
     *
     * @code
     * //example
     *
     * char agenturl[]="http://apg.xplora.com:8000";
     * 
     * if (!QX_SUPL_SDK_SUCCEEDED(QX_supl_sdk_agent_url_set(agentUrl))
     *      goto failure_config_agent_url;
     * @endcode
     *
     * @param[in] If the QianXun server is accessed by agent, this parameter cannot be empty
     *
     * @return 0 : agent url config success
     */
    extern int QX_supl_sdk_agent_url_set(char *agentUrl);
