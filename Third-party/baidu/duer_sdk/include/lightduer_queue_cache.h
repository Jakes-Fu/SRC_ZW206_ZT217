...
int duer_qcache_erase(
        duer_qcache_handler cache, duer_qcache_iterator prev_it, duer_qcache_iterator it);
int duer_qcache_move_to_head(
        duer_qcache_handler cache, duer_qcache_iterator prev_it, duer_qcache_iterator it);

void duer_qcache_delete(duer_qcache_handler cache, void *data);
