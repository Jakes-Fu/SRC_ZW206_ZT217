...
ifeq ($(strip $(BAIDU_VIDEOCHAT_SUPPORT)), TRUE)
MINCPATH += Third-party/brtc/include
MINCPATH += $(MMI_DIR)/source/mmi_app/app/brtc/h
MSRCPATH +=  $(MMI_DIR)/source/mmi_app/app/brtc/c
SOURCES	 += baidu_videocall.c
endif
...
#delete by bao for baidu ai complie error BAIDU_AI_SUPPORT
...
SOURCES += zdt_yx.c zdt_yx_net.c zdt_yx_api.c zdt_yx_db.c zdt_yx_func.c zdt_yx_captrue.c zdt_yx_voice.c zdt_yx_sms.c zdt_yx_wintable.c zdt_yx_voice_wintable.c
endif
endif
endif
...
ifeq ($(strip $(ZYB_APP_SUPPORT)), TRUE)
MINCPATH += $(MMI_DIR)/source/mmi_app/app/zyb/h
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/zyb/c
SOURCES += zyb_app.c zyb_wintable.c zyb_nv.c zyb_menutable.c zyb_id.c zyb_common.c zyb_http_api.c zyb_http_net.c zyb_mp3_info.c zyb_stream_player.c
endif
...
#add baidu codes
MINCPATH += $(MMI_DIR)/source/mmi_app/app/duer/h
MINCPATH += Third-party/baidu/lightduer/include
MINCPATH += Third-party/baidu/duer_sdk/include
MINCPATH += Third-party/baidu/audio-decoder/include
MINCPATH += Third-party/baidu/speech_sdk/include
MINCPATH += Third-party/baidu/lightduer_app/include
# baidu add end
endif
...
MINCPATH		+=  MS_MMI_Main/source/mmi_app/app/zmt_dial/h
MSRCPATH		+=  MS_MMI_Main/source/mmi_app/app/zmt_dial/c
SOURCES			+=  zmt_dial.c zmt_dial_store.c
endif
