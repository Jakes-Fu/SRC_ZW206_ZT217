...
SRCPATH  += $(MMI_DIR)/source/mmi_app/app/zyb/h
SOURCES	 += zyb_mdu_def.h
endif
...
#baidu add begin
SRCPATH += $(MMI_DIR)/source/mmi_app/app/duer/h
SOURCES += duer_mdu_def.h
# SRCPATH += $(MMI_DIR)/source/mmi_app/app/duerinput/h
# SOURCES += duerinput_mdu_def.h
#baidu add end
endif
