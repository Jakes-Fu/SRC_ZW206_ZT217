...
### mmi slide support
# SOURCES	 += mmi_slide.c  #.c��.h����MMI_SLIDE_SUPPORT ���ƣ����MMI_SLIDE_SUPPORT���Σ�������slide���code����������link
...
# #add baidu codes
MINCPATH += $(MMI_DIR)/source/mmi_app/app/duer/h
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/duer/c
...
MINCPATH += Third-party/qrencode
MINCPATH += Third-party/mbedtls-mbedtls/include
MINCPATH += Third-party/cJSON

#add baidu src file 
#add duer app src file
SOURCES += duerapp_homepage.c duerapp_main.c duerapp_id.c duerapp_nv.c duerapp_common.c duerapp_qrwin.c duerapp_center.c duerapp_center_list.c duerapp_sfs_cfg.c duerapp_slide_indicator.c
SOURCES += duerapp_dcs.c duerapp_system.c duerapp_operate.c duerapp_playing_timer.c
SOURCES += duerapp_mplayer.c duerapp_res_down.c
SOURCES += duerapp_writing.c 
SOURCES += duerapp_dict_activity.c duerapp_dict_cloud.c
SOURCES += duerapp_interpreter_activity.c
SOURCES += duerapp_assists_activity.c
SOURCES += duerapp_operate_comqr.c
# baidu add end
