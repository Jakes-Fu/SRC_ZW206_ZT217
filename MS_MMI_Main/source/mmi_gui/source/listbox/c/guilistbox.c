...
)
{
	...
	case GUIITEM_STYLE_ONE_LINE_ICON_TEXT_ICON_XMLY_VOICE_HEAD:
	case GUIITEM_STYLE_ONE_LINE_ICON_TEXT_ICON_XMLY_VOICE_BOTTOM:
	case GUIITEM_STYLE_ONE_LINE_TEXT_ICON_XMLY:
	case GUIITEM_STYLE_ONE_LINE_ICON_ICON_TEXT_ICON_XMLY:
	case GUIITEM_STYLE_ONE_LINE_TEXT_ICON_ICON_TEXT_TEXT:
	case GUIITEM_STYLE_ONE_LINE_ICON_ICON_TEXT_TEXT:
	case GUIITEM_STYLE_ONE_LINE_ICON_ICON_ICON_TEXT:
	case GUIITEM_STYLE_ONE_LINE_ICON_ICON_TEXT_ICON_HISTORY:
#endif
#ifndef MMI_THEME_LIST_MINI_SUPPORT
...
//                           For Engineer Mode                                //
    ...
    case GUIITEM_SYTLE_ZMT_HANZI_TEXT_MS:
