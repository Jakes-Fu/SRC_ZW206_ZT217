...
#ifdef ZTE_WATCH
    case GUIITEM_STYLE_1ICON_1STR_1LINE_BIG_LAYOUT1:
    case GUIITEM_STYLE_1STR_1LINE_BIG_LAYOUT1:
    case GUIITEM_STYLE_1STR_1LINE_RADIO_BIG_LAYOUT1:
    case GUIITEM_STYLE_1ICON_2STR_1LINE_LAYOUT:
#endif
...
//                           For Engineer Mode                                //
    ...
    case GUIITEM_STYLE_LF_ONE_LINE_BGICON_TEXT_MS:
    case GUIITEM_STYLE_LF_ONE_LINE_BGICON_R_TEXT_MS:
    case GUIITEM_STYLE_LF_TWO_LINE_BGICON_TEXT_MS:
    case GUIITEM_STYLE_LF_TWO_LINE_BGICON_R_TEXT_MS:
#endif
#ifdef ZTE_WATCH
    ...
    case GUIITEM_STYLE_GPT_ONE_ICON_AND_ONE_TEXT_MS:
