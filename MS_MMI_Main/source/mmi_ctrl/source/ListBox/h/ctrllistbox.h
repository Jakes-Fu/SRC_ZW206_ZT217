...
typedef uint8 ZMTLIST_STYLE_TD_E;
enum
{
	ZMTLIST_STYLE_NONE = 0,
	ZMTLIST_STYLE_GPT_MINE,
	ZMTLIST_STYLE_GPT_AI,
	ZMTLIST_STYLE_GPT_MINE_MORE,
	ZMTLIST_STYLE_GPT_AI_MORE,
};
#endif
...
PUBLIC uint16 LIST_GetLastPageItemNum(CTRLLIST_OBJ_T *list_ctrl_ptr);
