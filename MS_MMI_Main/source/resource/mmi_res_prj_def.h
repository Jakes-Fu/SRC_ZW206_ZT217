...
// baidu add start
RES_ADD_MODULE(MMI_MODULE_DUER,"\\duer\\duer_mdu_def.h")
// baidu add end
#endif
...
RES_ADD_MODULE(MMI_MODULE_ZYB,"\\zyb\\zyb_mdu_def.h")
#endif
...
#else
#ifdef ZTE_WATCH
RES_ADD_RING(R_CALL_1,"\\RING\\R_Call1_Leaping_Elf.mp3")
#else
...
//#endif
#ifdef ZTE_WATCH
RES_ADD_RING(R_POWER_1,"\\RING\\Watch-StartupSound-Final.mp3")
#endif
...
RES_ADD_FONT(LANG_FONT_LATIN_YINBIAO_1,"\\FONT\\ADD_YINBIAO_FONT_FILE_1.lib","")
#else
...
RES_ADD_LOGO(LOGO_1,"\\logo_landscape.bmp",IMG_CMP_BMP_16_565_RLE,0)
#else
#if defined(ZTE_WATCH)
    #ifdef MAINLCD_DEV_SIZE_240X284
    RES_ADD_LOGO(LOGO_1,"\\logo_zte_240x284.bmp",IMG_CMP_BMP_16_565_RLE,0)
    #else
    RES_ADD_LOGO(LOGO_1,"\\logo_zte_240x240.bmp",IMG_CMP_BMP_16_565_RLE,0)
    #endif
#else
RES_ADD_LOGO(LOGO_1,"\\logo.bmp",IMG_CMP_BMP_16_565_RLE,0)
#endif
...
#endif
#if defined(VIDEO_CALL_AGORA_SUPPORT)||defined(BAIDU_VIDEOCHAT_SUPPORT) //声网视频通话
