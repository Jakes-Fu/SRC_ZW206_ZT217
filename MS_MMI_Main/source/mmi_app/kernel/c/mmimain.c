                              ...
                              )
{
    ...
    case CHR_CHARGE_LOWTEMP:
        signal_code = CHR_MSG_CHARGE_LOW_TEMPTURE_IND;
        signal_size = sizeof(xSignalHeaderRec);
    ...
    case CHR_CHARGE_HOTTEMP:
        signal_code = CHR_MSG_CHARGE_HOT_TEMPTURE_IND;
        signal_size = sizeof(xSignalHeaderRec);
...
#if defined(W217_UWS6121EG_GNSS_PATCH_20231019)
