...
#define SET_PROGRESSBAR_RECT DP2PX_RECT(12,152, 228, 173)
#define SET_PROGRESSBAR_TOUCHRECT DP2PX_RECT(5,140, 235, 185)
#else
...
#define WATCH_SETOK_BTN_RECT     DP2PX_RECT(12,MMI_MAINSCREEN_HEIGHT - 70,228,MMI_MAINSCREEN_HEIGHT -20)
#define SET_BTN_TWO_LEFT_RECT     DP2PX_RECT(5,MMI_MAINSCREEN_HEIGHT-80,110,MMI_MAINSCREEN_HEIGHT-30)
#define SET_BTN_TWO_RIGHT_RECT    DP2PX_RECT(130,MMI_MAINSCREEN_HEIGHT-80,MMI_MAINSCREEN_WIDTH,MMI_MAINSCREEN_HEIGHT-30)
