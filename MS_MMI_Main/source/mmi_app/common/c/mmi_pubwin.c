...
PUBLIC void MMIPUB_OpenAlertTimerWin(MMI_TEXT_ID_T text_id)
{
    uint32 time_out = MMI_3SECONDS;
    
    MMIPUB_OpenAlertWinByTextId(&time_out,text_id,TXT_NULL,IMAGE_PUBWIN_FAIL,PNULL,PNULL,MMIPUB_SOFTKEY_ONE,PNULL);
