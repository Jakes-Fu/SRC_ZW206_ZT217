        ...
        {    
            switch(list_content_ptr[i].item_style)
            {
                ...
                case GUIITEM_STYLE_1ICON_1STR_1LINE_BIG_LAYOUT1:
                {
                    WATCHCOM_LIST_ITEM_STYLE_1ICON_1STR_ST item_data = *(WATCHCOM_LIST_ITEM_STYLE_1ICON_1STR_ST *)(list_content_ptr[i].data_ptr);
                    MMI_GetLabelTextByLang(item_data.text_id, &item_str1);
                    WatchCOM_ListItem_Draw_1Icon_1Str_Big(list_ctrl_id,item_data.image_id,item_str1);
                    user_data = (uint32)(list_content_ptr[i].item_callback);
                    GUILIST_SetItemUserData(list_ctrl_id, item_index, &user_data);
                    item_index++;
                    break;
                ...
                case GUIITEM_STYLE_1STR_1LINE_BIG_LAYOUT1:
                {
                    WATCHCOM_LIST_ITEM_STYLE_1STR_ST item_data = *(WATCHCOM_LIST_ITEM_STYLE_1STR_ST *)(list_content_ptr[i].data_ptr);
                    MMI_GetLabelTextByLang(item_data.text_id, &item_str1);
                    WatchCOM_ListItem_Draw_1Str_Big(list_ctrl_id,item_str1);
                    user_data = (uint32)(list_content_ptr[i].item_callback);
                    GUILIST_SetItemUserData(list_ctrl_id, item_index, &user_data);
                    item_index++;
                    break;
...
PUBLIC BOOLEAN WatchCOM_RadioList_Create(WATCHCOM_LIST_ITEM__ST *list_content_ptr, uint32 list_total_num,MMI_CTRL_ID_T list_ctrl_id)
{
    ...
    for(i=0; i<list_total_num; i++)
    {
        ...
        #ifdef ZTE_WATCH
        else if(TRUE == list_content_ptr[i].item_visible()&& GUIITEM_STYLE_1STR_1LINE_RADIO_BIG_LAYOUT1 == list_content_ptr[i].item_style)
        {    
            WATCHCOM_LIST_ITEM_STYLE_1STR_RADIO_ST item_data = *(WATCHCOM_LIST_ITEM_STYLE_1STR_RADIO_ST *)(list_content_ptr[i].data_ptr);
            MMI_GetLabelTextByLang(item_data.text_id, &item_str1);
            WatchCOM_ListItem_Draw_1Str_Radio_Big(list_ctrl_id,item_str1);
            user_data = (uint32)(list_content_ptr[i].item_callback);
            GUILIST_SetItemUserData(list_ctrl_id, item_index, &user_data);
            item_index++;
        }
...
//  Note:
/*****************************************************************************/
PUBLIC void WatchCOM_ListItem_Draw_1Str_Big(
                                    MMI_CTRL_ID_T listCtrlId,
                                    MMI_STRING_T string)
{
    GUILIST_ITEM_T          item_t          = {0};
    ...
    item_t.item_style = GUIITEM_STYLE_1STR_1LINE_BIG_LAYOUT1;
...
//  Note:
/*****************************************************************************/
PUBLIC void WatchCOM_ListItem_Draw_1Str_Radio_Big(
                                    MMI_CTRL_ID_T listCtrlId,
                                    MMI_STRING_T string)
{
    GUILIST_ITEM_T          item_t          = {0};
    GUILIST_ITEM_DATA_T     item_data       = {0};
    item_t.item_style = GUIITEM_STYLE_1STR_1LINE_RADIO_BIG_LAYOUT1;
...
//  Note:
/*****************************************************************************/
PUBLIC void WatchCOM_ListItem_Draw_1Icon_1Str_Big(
                                    MMI_CTRL_ID_T listCtrlId,
                                    MMI_IMAGE_ID_T image,
                                    MMI_STRING_T string)
{
    ...
    item_t.item_style = GUIITEM_STYLE_1ICON_1STR_1LINE_BIG_LAYOUT1;
