  ...
  //  ver_space = 2;
...
#endif
    {
        ...
        else
        {
            ...
            GUILABEL_SetFont(select_label_ctr_id, DP_FONT_14, MMI_DEFAULT_TEXT_COLOR);
            width_info.type = GUIFORM_CHILD_WIDTH_FIXED;
                            ...
                            )
{
    ...
    if (MMISET_IDLE_ISTYLE == MMIAPISET_GetIdleStyle()) 
    {
        GUITAB_SetFontParam(MMK_GetCtrlHandleByWin(win_id, MMIPB_SEARCH_LIST_TAB_CTRL_ID), DP_FONT_16, MMI_WHITE_COLOR, 0); /* tab's theme is Not OK*/
    }
#endif
#endif    
...
/*#ifdef MMI_PDA_SUPPORT 
   ...
   // GUIEDIT_SetFont(search_editbox_handle,DP_FONT_14);
...
LOCAL void InitOperateSelControl(MMI_WIN_ID_T win_id, MMIPB_OPERATE_TYPE_E oper_type)
{
  ...
  //  GUIFORM_SetChildAlign(child_title_form_handle, title_label_handle, GUIFORM_CHILD_ALIGN_RIGHT);
    ...
    GUILABEL_SetFont(title_label_handle, DP_FONT_14, MMI_DEFAULT_TEXT_COLOR);
