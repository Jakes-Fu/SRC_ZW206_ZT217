...
LOCAL void UpdateCallLogWinList(void)
{
    ...
    for ( i = 0; i < arraycallInfo->record_num; i++ )
    {
        ...
        item_data.item_content[0].item_data.image_id = arraycallInfo->call_info[i].photo_image_id;
        ...
        {
            item_data.item_content[1].font_color_id=MMITHEME_COLOR_RED;
            item_data.item_content[1].is_default =TRUE;        
        }
        else
        {
            item_data.item_content[1].font_color_id=MMITHEME_COLOR_NONE;
        }
        item_data.item_content[1].item_data_type = GUIITEM_DATA_TEXT_BUFFER;
        item_data.item_content[1].item_data.text_buffer.wstr_ptr = numberStr.wstr_ptr;
        item_data.item_content[1].item_data.text_buffer.wstr_len = numberStr.wstr_len;
        if (0<arraycallInfo->call_info[i].call_start_time)
        {
            ...
            item_data.item_content[2].item_data.text_buffer.wstr_ptr = dateTimeStr.wstr_ptr;
...
#endif
            WATCHCOM_DisplayTitleWithBg(win_id,STXT_MAIN_CL);
