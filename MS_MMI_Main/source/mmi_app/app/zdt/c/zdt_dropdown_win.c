...
#else
    GUI_RECT_T              signal_str_rect     = DP2PX_RECT(34,1,55,34);
    GUI_RECT_T              volte_rect     = DP2PX_RECT(2,6,34,30);
    GUI_RECT_T            text_str_rect     = DP2PX_RECT(30,4,48,18);
#endif
    char                 * str_char = "";
...
PUBLIC void ZDT_DisplayBattery(MMI_WIN_ID_T win_id, GUI_LCD_DEV_INFO lcd_dev_info)
{
    ...
    GUI_RECT_T              bat_str_rect     = {100,1,126,18};
#endif
...
LOCAL void DisplayWeather(MMI_WIN_ID_T win_id)
{
    ...
    GUI_RECT_T    wt_rect = DROPDOWN_WEATHER_TEXT_RECT;
    GUI_RECT_T    temperature_rect = DROPDOWN_WEATHER_TEMP_RECT;   
    GUI_RECT_T    city_rect = DROPDOWN_WEATHER_CITY_RECT;
    GUI_POINT_T weather_icon_point = DROPDOWN_WEATHER_ICON_POINT;
    GUI_POINT_T weather_Location_icon_point = DROPDOWN_WEATHER_LOCATION_POINT;
...
GUI_POINT_T   display_point = {0};
    ...
    GUIRES_DisplayImg(&weather_icon_point,PNULL,PNULL,win_id, weather_img_id,&lcd_dev_info); 
...
PUBLIC void ZDT_DisplayLoginIcon(MMI_WIN_ID_T win_id, GUI_LCD_DEV_INFO lcd_dev_info)
{
    ...
    {
        GUI_POINT_T point = DROPDOWN_LOGIN_ICON_POINT;
...
PUBLIC void ZDT_DisplayDataInOutIcon(MMI_WIN_ID_T win_id, GUI_LCD_DEV_INFO lcd_dev_info)
{
    ...
    {
        GUI_POINT_T point = DROPDOWN_DATA_IN_OUT_ICON_POINT;
...
LOCAL void ZDT_DropDownWin_DisplayBg(MMI_WIN_ID_T        win_id)
{
    ...
    GUI_RECT_T weather_rect = DROPDOWN_WEATHER_RECT;
    MMK_GetWinLcdDevInfo(win_id, &lcd_dev_info);
