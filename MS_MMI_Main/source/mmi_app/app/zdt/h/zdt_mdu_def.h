...
RES_ADD_STRING(TXT_ZDT_MAINMENU_ALARM,"ÄÖÖÓ")
...
RES_ADD_IMG(IMAGE_DIAL_NUMBER_IN,"\\MMI_RES_##\\IMAG\\Dial\\INPUT.png",IMG_CMP_PNG_ARGB_RLE,0)
...
RES_ADD_IMG(IMAGE_ZDT_NUMBER_BG,"\\MMI_RES_##\\IMAG\\Dial\\bg.png",IMG_CMP_PNG_ARGB_RLE,0)
...
RES_ADD_IMG(IMAGE_TINYCHAT_UNREAD_T,"\\MMI_RES_##\\IMAG\\tinychat\\unread_text.png",IMG_CMP_PNG_ARGB_RLE,0)
...
#ifndef ZDT_NEW_BIND_STYLE   //  xiongkai  È¥µôÃ»ÓÃµ½µÄÍ¼Æ¬  ½ÚÊ¡¿Õ¼ä        
...
RES_ADD_STRING(TXT_FATHER,"Father") //°Ö°Ö
RES_ADD_STRING(TXT_MOTHER,"Mother") //ÂèÂè
RES_ADD_STRING(TXT_FATHER_EX,"Father") //¸¸Ç×
RES_ADD_STRING(TXT_MOTHER_EX,"Mother") //Ä¸Ç×
...
RES_ADD_STRING(TXT_NONE_WECHAT_LIST,"ÔÝÎÞÁÄÌì¼ÇÂ¼")
