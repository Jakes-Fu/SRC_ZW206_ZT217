...
#define VIDEO_CALL_INCOMING_HANGUP_RECT {34,180,86,232}
#define VIDEO_CALL_INCOMING_ACCRPT_RECT {154,180,206,232}
#ifdef BAIDU_VIDEOCHAT_SUPPORT // BAIDU VIDEO in call hangup button
#ifdef MAINLCD_DEV_SIZE_240X284
#define VIDEO_CALL_IN_VIDEO_HANGUP_RECT {90, 206, 149, 265}
#define VIDEO_CALL_OUT_HANGUP_RECT {90, 206, 149, 265}
#else
#define VIDEO_CALL_IN_VIDEO_HANGUP_RECT {90, 176, 149, 225}
#define VIDEO_CALL_OUT_HANGUP_RECT {90, 176, 149, 225}
#endif
#else
