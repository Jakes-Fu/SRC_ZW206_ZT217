...
extern uint8 YX_Func_GetGPSLat(uint8 * pData,float Latitude,uint32 Lat_m,uint8 Lat_Dir);
extern uint8 YX_Func_GetGPSLong(uint8 * pData,float Longitude,uint8 long_Dir);
#else
