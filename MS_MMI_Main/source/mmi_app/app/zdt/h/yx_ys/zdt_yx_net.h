...
extern uint16 YX_Net_Friend_End(BOOLEAN is_ok,uint16 err_id,uint8 * friend_name, uint8 * friend_number);
extern uint16 YX_Net_Friend_Start(YX_APP_T * pMe);
#endif
