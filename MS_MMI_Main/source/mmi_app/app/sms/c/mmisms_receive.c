                                                        ...
                                                        )
{
    ...
    if (is_long_sms)
    {
        ...
        else
        {
            ...
            while(j <= receive_num)
            {
                if(ZDT_SMS_CONTENT_MAX_LEN <= valid_date_ptr->length)
                {
                    valid_date_ptr->length = ZDT_SMS_CONTENT_MAX_LEN;
                    break;
                }
                for(i = 1;i < receive_num;i++)
                {
                    ...
                    {
                        copy_len = MIN(ZDT_SMS_CONTENT_MAX_LEN - valid_date_ptr->length, s_long_zdtsms_ptr->zdt_sms[sms_index[i]].length);
                    ...
                    {
                        copy_len = MIN(ZDT_SMS_CONTENT_MAX_LEN - valid_date_ptr->length, user_data_ptr->user_valid_data_t.length);
