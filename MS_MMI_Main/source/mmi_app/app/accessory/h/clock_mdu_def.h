...
RES_ADD_STRING(TXT_ALARM_WILL_TO,"Device Will shut down")
...
RES_ADD_STRING(TXT_NO_ALARM_TIP,"Please set alarm")
#ifdef LOCAL_ALARM_CLOCK_SUPPORT 
RES_ADD_STRING(TXT_ADD_ALARM,"Add alarm")
#endif
...
RES_ADD_IMG(res_alarm_ring,"\\MMI_RES_##\\IMAG\\Alarm\\alarm_ring.png", IMG_CMP_PNG_ARGB_RLE,0)
RES_ADD_STRING(TXT_CUR_ALARM,"当前闹钟")
RES_ADD_IMG(alarm_edit_list_del_btn,"\\MMI_RES_##\\IMAG\\Alarm\\alarm_edit_list_del_btn.png",IMG_CMP_PNG_ARGB_RLE,0)
#endif
