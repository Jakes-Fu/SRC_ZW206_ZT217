...
#endif
#else
#define   GALLERY_PIC_DEL_BUTTON_RECT       DP2PX_RECT(11,179,227,227)
#define   GALLERY_PIC_ANIM_RECT             DP2PX_RECT(0,0,239,239)
#endif
/**--------------------------------------------------------------------------*
 **                          LOCAL FUNCTION                                  *
 **--------------------------------------------------------------------------*/
...
#endif*/
	delete_rect.left = DP2PX_VALUE(20);
	delete_rect.right = DP2PX_VALUE(60);
	delete_rect.top = DP2PX_VALUE(20);
	delete_rect.bottom = DP2PX_VALUE(60);
	switch_rect.left = DP2PX_VALUE(180);
	switch_rect.right = DP2PX_VALUE(220);
	switch_rect.top = DP2PX_VALUE(20);
	switch_rect.bottom = DP2PX_VALUE(60);
