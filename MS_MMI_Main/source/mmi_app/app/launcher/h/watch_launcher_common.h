...
**                         MACRO DEFINITION                                  *
**---------------------------------------------------------------------------*/
#define LAUNCHER_WIDTH (MMI_MAINSCREEN_WIDTH)
#define LAUNCHER_HEIGHT (MMI_MAINSCREEN_HEIGHT)
...
#define LAUNCHER_CLIENT_RECT {0,0,MMI_MAINSCREEN_WIDTH,MMI_MAINSCREEN_HEIGHT}
...
#endif
#define LAUNCHER_INDICATOR_RECT {DP2PX_VALUE(32),DP2PX_VALUE(220),MMI_MAINSCREEN_WIDTH-1,MMI_MAINSCREEN_HEIGHT}
#define LAUNCHER_NOTIFY_AREA {0, 0, MMI_MAINSCREEN_WIDTH, DP2PX_VALUE(30)}
#define LAUNCHER_SOFTKEY_AREA {0, MMI_MAINSCREEN_HEIGHT-LAUNCHER_BOTTOM_MARGIN, MMI_MAINSCREEN_WIDTH, MMI_MAINSCREEN_HEIGHT}
#define LAUNCHER_PAGE_TITLE_RECT {LAUNCHER_TITLE_LEFT_MARGIN, LAUNCHER_TOP_MARGIN, DP2PX_VALUE(192), LAUNCHER_TOP_MARGIN + DP2PX_VALUE(30)}
