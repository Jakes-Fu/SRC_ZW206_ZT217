...
#else
#define LAUNCHER_CHARGE_DEFAULT_FONT_SIZE DP_FONT_24
#define LAUNCHER_CHARGE_TIP_DURATION 1500
#define LAUNCHER_CHARGE_BACKGROUND_COLOR MMI_BLACK_COLOR
...
#else
#define LAUNCHER_CHARGE_STATE_RECT DP2PX_RECT(0, 8, 240, 40)
#define LAUNCHER_CHARGE_VALUE_RECT DP2PX_RECT(0, 42, 240, 62)
#define LAUNCHER_CHARGE_IMAGE_RECT DP2PX_RECT(70, 68, 170, 208)
#define LAUNCHER_BATTERYLOW_IMAGE_RECT DP2PX_RECT(84, 22, 84+72, 22+72)
#define LAUNCHER_BATTERYLOW_TIP_RECT DP2PX_RECT(12, 22+72+12, 228, 240-72)
#endif
#define LAUNCHER_BATTERYLOW_CONFIRM_RECT DP2PX_RECT(12, 240-12 -48, 228, 240-12)
#endif
