                                         ...
                                         )
{
    ...
    switch(msg_id)
    {
        ...
        case MSG_FULL_PAINT:
        {
		    ...
		    GUI_RECT_T          content_rect={0,MMI_SPECIAL_TITLE_HEIGHT,128 ,128}; ////xiongkai ADD_TITLE_IN_ALL_SETTING_MENU	
	...
	GUISTR_DrawTextToLCDInRect( 
        ...
        case MSG_KEYUP_RED:
            MMK_CloseWin(win_id);
            break;
        case MSG_NOTIFY_UPDATE: //刷新TextBox 背景
        {
            //MMK_SendMsg(win_id, MSG_FULL_PAINT, PNULL);
            GUI_RECT_T      text_rect = WATCH_ABOUT_RECT;
            GUI_LCD_DEV_INFO    lcd_dev_info = {GUI_MAIN_LCD_ID,GUI_BLOCK_MAIN};
            GUIRES_DisplayImg(PNULL,&text_rect,&text_rect,win_id,IMAGE_THEME_BLACK_BG_SPEC,&lcd_dev_info);
        }
            break;
        default:
