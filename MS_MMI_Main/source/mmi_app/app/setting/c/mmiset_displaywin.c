...
#define SET_PROGRESSBAR_TOTAL_LENGTH    DP2PX_VALUE(216)
#define SET_PROGRESSBAR_PERLEVEL_LENGTH DP2PX_VALUE(36)
#define PROGRESSBAR_BRIGTH_LEVEL_MAX 6
#define BRIGHT_ICON_B_X	DP2PX_VALUE(90)
#define BRIGHT_ICON_B_Y	DP2PX_VALUE(30)
#define BRIGHT_ICON_VOL_X	DP2PX_VALUE(102)
#define BRIGHT_ICON_VOL_Y	DP2PX_VALUE(57)
#else
#define SET_BTN_TWO_LEFT_RECT     DP2PX_RECT(5,180,110,240)
#define SET_BTN_TWO_RIGHT_RECT    DP2PX_RECT(130,180,240,240)

#define SET_BTN_MINUS_RECT     DP2PX_RECT(22,190,80,240)
#define SET_BTN_PLUS_RECT    DP2PX_RECT(168,190,220,240)

#define BRIGHT_IMAGE_X	DP2PX_VALUE(66)
#define BRIGHT_IMAGE_Y	DP2PX_VALUE(80)

#define BRIGHT_ICON_X	DP2PX_VALUE(104)
#define BRIGHT_ICON_Y	DP2PX_VALUE(205)
#endif

#else

#ifdef ZTE_WATCH
#define SETOK_BTN_HEIGHT DP2PX_VALUE(40)
#define SET_PROGRESSBAR_RECT DP2PX_RECT(12,112, 228, 133)
...
#define PROGRESSBAR_BRIGTH_LEVEL_MAX 6
#define BRIGHT_ICON_B_X	DP2PX_VALUE(90)
#define BRIGHT_ICON_B_Y	DP2PX_VALUE(20)
#define BRIGHT_ICON_VOL_X	DP2PX_VALUE(102)
#define BRIGHT_ICON_VOL_Y	DP2PX_VALUE(37)
#define SET_BTN_TWO_LEFT_RECT     DP2PX_RECT(5,190,110,240)
#define SET_BTN_TWO_RIGHT_RECT    DP2PX_RECT(130,190,240,240)

#else
#define SET_BTN_TWO_LEFT_RECT     DP2PX_RECT(5,180,100,240)
#define SET_BTN_TWO_RIGHT_RECT    DP2PX_RECT(130,180,240,240)

#define SET_BTN_MINUS_RECT     DP2PX_RECT(22,145,100,210)
#define SET_BTN_PLUS_RECT    DP2PX_RECT(140,145,230,210)

#define BRIGHT_IMAGE_X	DP2PX_VALUE(55)
#define BRIGHT_IMAGE_Y	DP2PX_VALUE(84)

#define BRIGHT_ICON_X	DP2PX_VALUE(104)
#define BRIGHT_ICON_Y	DP2PX_VALUE(165)
#endif
...
void Brightness_Full_Paint( MMI_WIN_ID_T    win_id)
{
	...
	text_style.font = DP_FONT_28;//MMI_DEFAULT_EXTRA_BIG_FONT;
	...
	case MSG_TP_PRESS_UP:
		...
		case MSG_KEYUP_UP:	
		{
			...
			MMIAPISET_SetMainLCDContrast();
				...
				display_point.x = 18;//35*SCALE;//client_rect.v_rect.left;
				display_point.y =  38;//103*SCALE;///client_rect.v_rect.top;		
                                           ...
                                           )
{
    ...
    GUI_RECT_T          title_rect={0,0,MMI_MAINSCREEN_HEIGHT,MMI_SPECIAL_TITLE_HEIGHT}; 	
    GUI_LCD_DEV_INFO    lcd_dev_info = {GUI_MAIN_LCD_ID,GUI_BLOCK_MAIN};
    GUI_RECT_T          rect         = MMITHEME_GetFullScreenRectEx(win_id);	
    GUISTR_STYLE_T      text_style      = {0};/*lint !e64*/
    GUISTR_STATE_T      state =         GUISTR_STATE_ALIGN|GUISTR_STATE_WORDBREAK|GUISTR_STATE_SINGLE_LINE; 
                                           ...
                                           )
{
	...
	case MSG_CTL_PENOK:
		...
		if(MMISET_COMMON_L_BTN_CTRL_ID == ((MMI_NOTIFY_T*)param)->src_id)//reset button被选中
		{
			...
			{
				s_setting_call_volume_value = 1;//0;
                                           ...
                                           )
{
	...
	case MSG_CTL_PENOK:
		...
		if(MMISET_COMMON_L_BTN_CTRL_ID == ((MMI_NOTIFY_T*)param)->src_id)//reset button被选中
		{
			...
			{
				s_setting_ring_volume_value = 1;//0;
				cur_ring_volume_img_id = 1;//0;
			}				
...
//yangyu add begin
    case MSG_FULL_PAINT:
    {
    	...
    	text_style.font = DP_FONT_22;//DP_FONT_36*SCALE;//DP_FONT_26;
#else
    	text_style.font = DP_FONT_28;//DP_FONT_36*SCALE;//DP_FONT_26;
#endif    	
    	...
    	text_style.font_color = MMI_WHITE_COLOR;
	#if defined(ZDT_MMI_USE_SMALL_FONT)
    	text_style.font = DP_FONT_22;//DP_FONT_26*SCALE;	
	#else
    	text_style.font = DP_FONT_28;//DP_FONT_26*SCALE;
    	#endif
                                           ...
                                           )
{
    ...
    GUI_RECT_T	content_rect= MMITHEME_GetFullScreenRect();//{0,MMI_SPECIAL_TITLE_HEIGHT,MMI_MAINSCREEN_WIDTH,MMI_SPECIAL_TITLE_HEIGHT}; 
    rect.top =  0;
	...
	case MSG_OPEN_WINDOW:
		{
		GUI_FONT_T font = DP_FONT_24;//DP_FONT_16;
		...
		CTRLBUTTON_SetFontSize(MMISET_BRIGHTNESS_L_BTN_CTRL_ID,DP_FONT_24 );
		CTRLBUTTON_SetFontSize(MMISET_BRIGHTNESS_R_BTN_CTRL_ID,DP_FONT_24);
                                           ...
                                           )
{
   ...
   // GUISTR_STATE_T      state =         GUISTR_STATE_ALIGN|GUISTR_STATE_WORDBREAK|GUISTR_STATE_BOLD;//|GUISTR_STATE_SINGLE_LINE; 
...
#if defined(ADD_TITLE_IN_ALL_SETTING_MENU)	
		GUI_RECT_T			content_rect={0,MMI_SPECIAL_TITLE_HEIGHT,MMI_MAINSCREEN_WIDTH,MMI_MAINSCREEN_HEIGHT}; 
	...
	{
	#if defined(ZDT_MMI_USE_SMALL_FONT)
	    GUI_FONT_T font = DP_FONT_20;//DP_FONT_16;	
	#else
	    GUI_FONT_T font = DP_FONT_24;//DP_FONT_16;
	#endif	    
	    GUI_COLOR_T color = MMI_WHITE_COLOR;
                                           ...
                                           )
{
    ...
    GUI_RECT_T          content_rect={0,MMI_SPECIAL_TITLE_HEIGHT,MMI_MAINSCREEN_WIDTH,MMI_SPECIAL_TITLE_HEIGHT}; 
    GUI_RECT_T          title_rect={0,0,MMI_MAINSCREEN_HEIGHT,MMI_SPECIAL_TITLE_HEIGHT}; 	
    GUI_LCD_DEV_INFO    lcd_dev_info = {GUI_MAIN_LCD_ID,GUI_BLOCK_MAIN};
    GUI_RECT_T          rect         = MMITHEME_GetFullScreenRectEx(win_id);	
    GUISTR_STYLE_T      text_style      = {0};/*lint !e64*/
...
// 	    }
        ...
        //CTRLLIST_SetTextFont(MMISET_DISPLAY_BACKLIGHT_TIMEOUT_CTRL_ID, DP_FONT_28, MMI_WHITE_COLOR);//yangyu delete
