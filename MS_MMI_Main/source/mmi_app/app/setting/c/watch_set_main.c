...
//#ifdef SCREEN_SHAPE_CIRCULAR
        case MSG_FULL_PAINT:
        {
            ...
            WATCHCOM_DisplayTitleWithBg(win_id,STXT_MAIN_SETTING);
#endif
            break;
        }    
//#endif
...
#if defined(ADD_TITLE_IN_ALL_SETTING_MENU)	
    GUI_RECT_T          rect         = MMITHEME_GetFullScreenRectEx(win_id);	
    GUI_RECT_T          content_rect=WATCHLIST_RECT;//{0,MMI_SPECIAL_TITLE_HEIGHT,MMI_MAINSCREEN_WIDTH,MMI_SPECIAL_TITLE_HEIGHT};  ////xiongkai ADD_TITLE_IN_ALL_SETTING_MENU	
    GUI_RECT_T          title_rect={0,0,MMI_MAINSCREEN_HEIGHT,MMI_SPECIAL_TITLE_HEIGHT}; 	
    GUI_LCD_DEV_INFO    lcd_dev_info = {GUI_MAIN_LCD_ID,GUI_BLOCK_MAIN};
