...
#endif
LOCAL MMISET_TIME_DISPLAY_TYPE_E s_time_display_type = MMISET_TIME_12HOURS;
...
{
    uint8                           mainlcd_contrast        =   MMISET_CONTRAST_THREE;  
#ifdef TTS_SUPPORT
...
LOCAL void InitTimeDisplayType(void)
{
    ...
    if (MN_RETURN_SUCCESS != return_value)
    {
        s_time_display_type= MMISET_TIME_12HOURS;
        MMINV_WRITE(MMINV_SET_TIME_DISPLAY_TYPE, &s_time_display_type);
    }
}
                                    ...
                                    )
{
    ...
    if (MMISET_CONTRAST_SEVEN < mainlcd_contrast)
    {
        mainlcd_contrast = MMISET_CONTRAST_THREE;
    }
...
{
#if 0//defined(ANALOG_CLK_SUPPORT)   //xiongkai
    WATCH_PANEL_TYPE_T temp_style = {0 , 1};
#else
