...
#define WATCHLIST_ITEM_HEIGH                          DP2PX_VALUE(56) //DP2PX_VALUE(60)
#define WATCHLIST_LEFT_SPACE                         DP2PX_VALUE(15) //DP2PX_VALUE(10)
#define WATCHLIST_LEFT_SPACE_BIG                      DP2PX_VALUE(56)
#define WATCHLIST_RIGHT_SPACE                         DP2PX_VALUE(225)//screen_width-WATCHLIST_LEFT_SPACE
...
#ifdef ZTE_WATCH
//LIST_1STR_1LINE
#define LIST_1STR_1LINE_ITEM_BIG_HEIGH                    (WATCHLIST_ITEM_HEIGH+12)

//GUIITEM_STYLE_1ICON_1STR_1LINE_BIG_LAYOUT1,
#define LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH              (WATCHLIST_ITEM_HEIGH+12)

#define  LIST_1STR_1LINE_RADIO_BIG_ITEM_HEIGH   (WATCHLIST_ITEM_HEIGH+12)
...
#define LIST_2STR_1ICON_2LINE_ITEM_HEIGH              (WATCHLIST_ITEM_HEIGH+12)
