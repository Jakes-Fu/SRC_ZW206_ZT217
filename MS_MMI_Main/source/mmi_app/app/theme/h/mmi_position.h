...
#elif defined MAINLCD_DEV_SIZE_128X128
    #include "mmi_position_128X128.h"
#else
    #error
#endif
...
#define MMI_SPECIAL_TITLE_HEIGHT    DP2PX_VALUE(38)   //   240-3*MMI_LIST_ITEM_HEIGHT    //带返回箭头的title高度。  list一页只显示3个，显示4个的话太拥挤，不好手指操作
#endif
