...
#elif defined(MAINLCD_PANEL_SIZE_240X240) || defined (MAINLCD_PANEL_SIZE_360X360) || defined (MAINLCD_PANEL_SIZE_400X400) || defined(MAINLCD_DEV_SIZE_240X240) || defined (MAINLCD_DEV_SIZE_240X320) || defined (MAINLCD_DEV_SIZE_240X284)
	//标识为手表设备
