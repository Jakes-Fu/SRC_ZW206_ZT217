...
#define MMI_MAINSCREEN_WIDTH             128//   DP2PX_VALUE(240)

#ifndef ADULT_WATCH_SUPPORT
#define MMI_MAINSCREEN_HEIGHT            128//   DP2PX_VALUE(240)
#else
    #ifdef DP_SCREEN_SIZE_240x240
    #define MMI_MAINSCREEN_HEIGHT 128//DP2PX_VALUE(240)
    #else
    #define MMI_MAINSCREEN_HEIGHT      128//         320
    #endif
#endif

#if defined(ZTE_SUPPORT_240X284)||defined(MAINLCD_DEV_SIZE_240X284)
#define MMI_MAINSCREEN_HEIGHT      128//         DP2PX_VALUE(284)
#endif
