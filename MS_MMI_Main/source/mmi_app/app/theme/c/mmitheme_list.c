...
#define WATCHLIST_ICON_TEXT_HALE_LEFT DP2PX_VALUE(120)
#define WATCHLIST_ICON_TEXT_LEFT_SPACE DP2PX_VALUE(13)
#define WATCHLIST_BG_ICON_TOP_SPACE DP2PX_VALUE(4)
...
#define WATCHLIST_ICON_TEXT_TOP_SPACE DP2PX_VALUE(4)
#define WATCHLIST_ICON_NORMAL_WIDGH_HEIGHT_SPACE DP2PX_VALUE(48)
#define WATCHLIST_ICON_TEXT_RIGHT_SPACE DP2PX_VALUE(13)
#endif
...
{
    XYSDK_VOICE_LIST_H, XYSDK_VOICE_LIST_H,
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_1_bgicon_text_ms =
{
	...
	
    {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(44), 0,  DP2PX_VALUE(145 + 44),  39}, /*1*/
            { DP2PX_VALUE(44), 0,  DP2PX_VALUE(145 + 44),  39}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(138),  2,  DP2PX_VALUE(138 + 46) , 37},/*2*/
            { DP2PX_VALUE(138),  2,  DP2PX_VALUE(138 + 46) , 37},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 2, (40-38)/2,  DP2PX_VALUE(38 + 4),  40-(40-38)/2}, /*1*/
            { 2, (40-38)/2,  DP2PX_VALUE(38 + 4),  40-(40-38)/2}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(188), (40-14)/2,  DP2PX_VALUE(188 + 14),  40-(40-14)/2}, /*1*/
            { DP2PX_VALUE(188), (40-14)/2,  DP2PX_VALUE(188 + 14),  40-(40-14)/2}, /*1*/
            0, 0,
            0, 0
        },
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_2_bgicon_text_ms =
{
	...
	
    {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(199-140), 0,  DP2PX_VALUE(190),  39}, /*1*/
            { DP2PX_VALUE(199-140), 0,  DP2PX_VALUE(190),  39}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(199-145+2),  2,  DP2PX_VALUE(199-145+48) , 37},/*2*/
            { DP2PX_VALUE(199-145+2),  2,  DP2PX_VALUE(199-145+48) , 37},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        //playing audio icon, icon height 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(200-14), (40-38)/2,  DP2PX_VALUE(200+42),  40-(40-38)/2}, /*1*/
            { DP2PX_VALUE(200-14), (40-38)/2,  DP2PX_VALUE(200+42),  40-(40-38)/2}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { DP2PX_VALUE(30), (40-14)/2,  DP2PX_VALUE(30 + 14),  40-(40-14)/2}, /*1*/
            { DP2PX_VALUE(30), (40-14)/2,  DP2PX_VALUE(30 + 14),  40-(40-14)/2}, /*1*/
            0, 0,
            0, 0
        },
...
{
    WATCHLIST_ITEM_HEIGH, WATCHLIST_ITEM_HEIGH,
