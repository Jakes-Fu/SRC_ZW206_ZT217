...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_1_text_factory =
{
    66, 66,

    {
        {
            0,
            { MMI_LIST_ICON_LEFT_SPACE,   0,  MMI_LIST_ITEM_RIGHT - MMI_LIST_ICON_LEFT_SPACE,  56 - 1},
            { MMI_LIST_ICON_LEFT_SPACE,   0,  MMI_LIST_ITEM_RIGHT - MMI_LIST_ICON_LEFT_SPACE,  56 -1 },
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_EXPAND_ITEM_FONT,
            0, 100
        },
...
#ifdef ZTE_WATCH
#define ZDT_CHAT_LIST_HEAD_IMG_W 0
#define ZDT_CHAT_LIST_HEIGHT 50
#define ZDT_CHAT_LIST_WITH_NAME_HEIGHT 75
#define ZDT_CHAT_LIST_ITEM_NAME_HEIGHT ZDT_CHAT_LIST_WITH_NAME_HEIGHT-ZDT_CHAT_LIST_HEIGHT
#else
#define ZDT_CHAT_LIST_HEAD_IMG_W 40
#define ZDT_CHAT_LIST_HEIGHT 40
#endif

#define ZDT_CHAT_LIST_MARGIN 2

//GUIITEM_STYLE_LF_ONE_LINE_BGICON_TEXT_MS,
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_lf_1_bgicon_text_ms =
{
    ZDT_CHAT_LIST_HEIGHT, ZDT_CHAT_LIST_HEIGHT,
	
    {
        //background
        {
            GUIITEM_CONTENT_STATE_NONE,
            { ZDT_CHAT_LIST_HEAD_IMG_W, 0,  145 + ZDT_CHAT_LIST_HEAD_IMG_W,  ZDT_CHAT_LIST_HEIGHT-1}, /*1*/
            { ZDT_CHAT_LIST_HEAD_IMG_W, 0,  145 + ZDT_CHAT_LIST_HEAD_IMG_W,  ZDT_CHAT_LIST_HEIGHT-1}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145-48,  2,  145 , ZDT_CHAT_LIST_HEIGHT-3},/*2*/
            { 145-48,  2,  145 , ZDT_CHAT_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        //playing audio icon, icon height 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 2, (ZDT_CHAT_LIST_HEIGHT-38)/2,  38 + 2,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            { 2, (ZDT_CHAT_LIST_HEIGHT-38)/2,  38 + 2,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145 + ZDT_CHAT_LIST_HEAD_IMG_W, (ZDT_CHAT_LIST_HEIGHT-14)/2,  145 + ZDT_CHAT_LIST_HEAD_IMG_W + 14,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2}, /*1*/
            { 145 + ZDT_CHAT_LIST_HEAD_IMG_W, (ZDT_CHAT_LIST_HEIGHT-14)/2,  145 + ZDT_CHAT_LIST_HEAD_IMG_W + 14,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2}, /*1*/
            0, 0,
            0, 100
        },
        {
            GUIITEM_CONTENT_STATE_NONE,
            { ZDT_CHAT_LIST_HEAD_IMG_W+10,  2,  200 , ZDT_CHAT_LIST_HEIGHT-3},/*2*/
            { ZDT_CHAT_LIST_HEAD_IMG_W+10,  2,  200 , ZDT_CHAT_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145+ZDT_CHAT_LIST_HEAD_IMG_W+2, (ZDT_CHAT_LIST_HEIGHT-24)/2,  145+ZDT_CHAT_LIST_HEAD_IMG_W+30,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2}, /*1*/
            { 145+ZDT_CHAT_LIST_HEAD_IMG_W+2, (ZDT_CHAT_LIST_HEIGHT-24)/2,  145+ZDT_CHAT_LIST_HEAD_IMG_W+30,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2}, /*1*/
            0, 0,
            0, 100
        },
...
//GUIITEM_STYLE_LF_ONE_LINE_BGICON_R_TEXT_MS
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_lf_2_bgicon_text_ms =
{
    ZDT_CHAT_LIST_HEIGHT, ZDT_CHAT_LIST_HEIGHT,
	
    {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145, 0,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-ZDT_CHAT_LIST_MARGIN,  ZDT_CHAT_LIST_HEIGHT-1}, /*1*/
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145, 0,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-ZDT_CHAT_LIST_MARGIN,  ZDT_CHAT_LIST_HEIGHT-1}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145+2,  2,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145+48 , ZDT_CHAT_LIST_HEIGHT-3},/*2*/
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145+2,  2,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145+48 , ZDT_CHAT_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        //playing audio icon, icon height 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W, (ZDT_CHAT_LIST_HEIGHT-38)/2,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W+38,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W, (ZDT_CHAT_LIST_HEIGHT-38)/2,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W+38,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 30, (ZDT_CHAT_LIST_HEIGHT-14)/2,  30 + 14,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2}, /*1*/
            { 30, (ZDT_CHAT_LIST_HEIGHT-14)/2,  30 + 14,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2}, /*1*/
            0, 0,
            0, 100
        },
        {
            ...
            {ZDT_CHAT_LIST_HEAD_IMG_W+10,  2,  240-42, ZDT_CHAT_LIST_HEIGHT-3},/*2*/
            {ZDT_CHAT_LIST_HEAD_IMG_W+10,  2,  240-42, ZDT_CHAT_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        {
        ...
        //playing audio icon, icon height 24
        {
            GUIITEM_CONTENT_STATE_NONE,
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145-30, (ZDT_CHAT_LIST_HEIGHT-24)/2,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-146,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2}, /*1*/
            { MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-145-30, (ZDT_CHAT_LIST_HEIGHT-24)/2,  MMI_MAINSCREEN_WIDTH-ZDT_CHAT_LIST_HEAD_IMG_W-146,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2}, /*1*/
            0, 0,
            0, 100
        },
...
#ifdef ZTE_WATCH
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_lf_1_bgicon_with_top_text_ms =
{
    ZDT_CHAT_LIST_WITH_NAME_HEIGHT, ZDT_CHAT_LIST_WITH_NAME_HEIGHT,
	
    {
        //background
        {
            GUIITEM_CONTENT_STATE_NONE,
            { ZDT_CHAT_LIST_HEAD_IMG_W, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT,  145 + ZDT_CHAT_LIST_HEAD_IMG_W,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-1}, /*1*/
            { ZDT_CHAT_LIST_HEAD_IMG_W, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT,  145 + ZDT_CHAT_LIST_HEAD_IMG_W,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-1}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145-48,  ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+2,  145 , ZDT_CHAT_LIST_WITH_NAME_HEIGHT-3},/*2*/
            { 145-48,  ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+2,  145 , ZDT_CHAT_LIST_WITH_NAME_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        //playing audio icon, icon height 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 2, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+(ZDT_CHAT_LIST_HEIGHT-38)/2,  38 + 2,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            { 2, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+(ZDT_CHAT_LIST_HEIGHT-38)/2,  38 + 2,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145 + ZDT_CHAT_LIST_HEAD_IMG_W, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+(ZDT_CHAT_LIST_HEIGHT-14)/2,  145 + ZDT_CHAT_LIST_HEAD_IMG_W + 14,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2}, /*1*/
            { 145 + ZDT_CHAT_LIST_HEAD_IMG_W, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+(ZDT_CHAT_LIST_HEIGHT-14)/2,  145 + ZDT_CHAT_LIST_HEAD_IMG_W + 14,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2}, /*1*/
            0, 0,
            0, 100
        },
        {
            GUIITEM_CONTENT_STATE_NONE,
            { ZDT_CHAT_LIST_HEAD_IMG_W+10,  ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+2,  200 , ZDT_CHAT_LIST_WITH_NAME_HEIGHT-3},/*2*/
            { ZDT_CHAT_LIST_HEAD_IMG_W+10,  ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+2,  200 , ZDT_CHAT_LIST_WITH_NAME_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        {
            GUIITEM_CONTENT_STATE_TEXT_M_ALIGN,
            { 4,  ZDT_CHAT_LIST_ITEM_NAME_HEIGHT,  240-4, ZDT_CHAT_LIST_WITH_NAME_HEIGHT},/*2*/
            { 4,  ZDT_CHAT_LIST_ITEM_NAME_HEIGHT,  240-4, ZDT_CHAT_LIST_WITH_NAME_HEIGHT},
            SONG_FONT_20, SONG_FONT_20,
            0, 100
        },
         //playing audio icon, icon height 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145+ZDT_CHAT_LIST_HEAD_IMG_W+2, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+(ZDT_CHAT_LIST_HEIGHT-24)/2,  145+ZDT_CHAT_LIST_HEAD_IMG_W+30,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2}, /*1*/
            { 145+ZDT_CHAT_LIST_HEAD_IMG_W+2, ZDT_CHAT_LIST_ITEM_NAME_HEIGHT+(ZDT_CHAT_LIST_HEIGHT-24)/2,  145+ZDT_CHAT_LIST_HEAD_IMG_W+30,  ZDT_CHAT_LIST_WITH_NAME_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            {20,  0,  145 , ZDT_CHAT_LIST_WITH_NAME_HEIGHT-ZDT_CHAT_LIST_HEIGHT},/*2*/
            {20,  0,  145 , ZDT_CHAT_LIST_WITH_NAME_HEIGHT-ZDT_CHAT_LIST_HEIGHT},
            SONG_FONT_18, SONG_FONT_18,
            0, 100
        },
    },
...
#if 1
#define ZDT_CHAT_TWO_LIST_HEIGHT 60

//GUIITEM_STYLE_LF_TWO_LINE_BGICON_TEXT_MS,
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_lf2_1_bgicon_text_ms =
{
    ZDT_CHAT_TWO_LIST_HEIGHT, ZDT_CHAT_TWO_LIST_HEIGHT,
	
    {
        //background
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 40, 22,  145 + 40,  ZDT_CHAT_TWO_LIST_HEIGHT-1}, /*1*/
            { 40, 22,  145 + 40,  ZDT_CHAT_TWO_LIST_HEIGHT-1}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 138,  24,  138 + 46 , ZDT_CHAT_TWO_LIST_HEIGHT-3},/*2*/
            { 138,  24,  138 + 46 , ZDT_CHAT_TWO_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        //head img 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 2, (ZDT_CHAT_LIST_HEIGHT-38)/2+22,  38 + 2,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2+22}, /*1*/
            { 2, (ZDT_CHAT_LIST_HEIGHT-38)/2+22,  38 + 2,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2+22}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 188, (ZDT_CHAT_LIST_HEIGHT-14)/2+22,  188 + 14,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2+22}, /*1*/
            { 188, (ZDT_CHAT_LIST_HEIGHT-14)/2+22,  188 + 14,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-14)/2+22}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 42,  24,  185 , ZDT_CHAT_TWO_LIST_HEIGHT-3},/*2*/
            { 42,  24,  185 , ZDT_CHAT_TWO_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 145+40+2, (ZDT_CHAT_LIST_HEIGHT-24)/2+22,  145+40+30,  40-(ZDT_CHAT_LIST_HEIGHT-24)/2+22}, /*1*/
            { 145+40+2, (ZDT_CHAT_LIST_HEIGHT-24)/2+22,  145+40+30,  40-(ZDT_CHAT_LIST_HEIGHT-24)/2+22}, /*1*/
            0, 0,
            0, 100
        },
...
//GUIITEM_STYLE_LF_ONE_LINE_BGICON_R_TEXT_MS
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_lf2_2_bgicon_text_ms =
{
    ZDT_CHAT_LIST_HEIGHT, ZDT_CHAT_LIST_HEIGHT,
	
    {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 199-145, 0,  199,  ZDT_CHAT_LIST_HEIGHT-1}, /*1*/
            { 199-145, 0,  199,  ZDT_CHAT_LIST_HEIGHT-1}, /*1*/
            0, 0,
            0, 0
        },
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 199-145+2,  2,  199-145+48 , ZDT_CHAT_LIST_HEIGHT-3},/*2*/
            { 199-145+2,  2,  199-145+48 , ZDT_CHAT_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        //playing audio icon, icon height 40
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 200, (ZDT_CHAT_LIST_HEIGHT-38)/2,  200+38,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            { 200, (ZDT_CHAT_LIST_HEIGHT-38)/2,  200+38,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-38)/2}, /*1*/
            0, 0,
            0, 100
        },
        ...
        {
            GUIITEM_CONTENT_STATE_TEXT_R_ALIGN,
            { 46,  2,  240-42, ZDT_CHAT_LIST_HEIGHT-3},/*2*/
            { 46,  2,  240-42, ZDT_CHAT_LIST_HEIGHT-3},
            MMI_LIST_DEFAULT_ITEM_FONT, MMI_LIST_DEFAULT_ITEM_FONT,
            0, 100
        },
        {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            { 199-145-30, (ZDT_CHAT_LIST_HEIGHT-24)/2+22,  199-146,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2+22}, /*1*/
            { 199-145-30, (ZDT_CHAT_LIST_HEIGHT-24)/2+22,  199-146,  ZDT_CHAT_LIST_HEIGHT-(ZDT_CHAT_LIST_HEIGHT-24)/2+22}, /*1*/
            0, 0,
            0, 100
        },
...
// watch commonlist start
    ...
    //|        text               |
    //|---------------------------|
    //GUIITEM_STYLE_1STR_1LINE_BIG_LAYOUT1,
LOCAL THEMELIST_ITEM_STYLE_T const s_1str_1line_big_layout1 =
{
    LIST_1STR_1LINE_ITEM_BIG_HEIGH, LIST_1STR_1LINE_ITEM_BIG_HEIGH,

    {
        {
            0,
            { LIST_1STR_1LINE_LEFT,  LIST_1STR_1LINE_TOP,  LIST_1STR_1LINE_RIGHT,  LIST_1STR_1LINE_ITEM_BIG_HEIGH - LIST_1STR_1LINE_TOP},
            { LIST_1STR_1LINE_LEFT,  LIST_1STR_1LINE_TOP,  LIST_1STR_1LINE_RIGHT,  LIST_1STR_1LINE_ITEM_BIG_HEIGH - LIST_1STR_1LINE_TOP},
            WATCH_LISTITEM_NORMAL_FONT, WATCH_LISTITEM_NORMAL_FONT,
            0, 0
        },
...
//|---------------------------|
    //|   @     text              |
    //|---------------------------|
    //GUIITEM_STYLE_1ICON_1STR_1LINE_BIG_LAYOUT1,
LOCAL THEMELIST_ITEM_STYLE_T const s_1icon_1str_1line_big_layout1 =
{
    LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH, LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH,

    {
        {
            0,
            { LIST_1ICON_1STR_1LINE_LEFT,  (LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH - LIST_1ICON_1STR_1LINE_ICON_HEIGH)/2,  LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH,  (LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH - LIST_1ICON_1STR_1LINE_ICON_HEIGH)/2 + LIST_1ICON_1STR_1LINE_ICON_HEIGH},
            { LIST_1ICON_1STR_1LINE_LEFT,  (LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH - LIST_1ICON_1STR_1LINE_ICON_HEIGH)/2,  LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH,  (LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH - LIST_1ICON_1STR_1LINE_ICON_HEIGH)/2 + LIST_1ICON_1STR_1LINE_ICON_HEIGH},
            0, 0,
            0, 0
        },
        {
            0,
            { LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH + LIST_1ICON_1STR_1LINE_ICON_AND_TEXT_OFFESET,  LIST_1ICON_1STR_1LINE_TOP,  LIST_1ICON_1STR_1LINE_RIGHT,  LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH - LIST_1ICON_1STR_1LINE_TOP},
            { LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH + LIST_1ICON_1STR_1LINE_ICON_AND_TEXT_OFFESET,  LIST_1ICON_1STR_1LINE_TOP,  LIST_1ICON_1STR_1LINE_RIGHT,  LIST_1STR_1ICON_1LINE_BIG_ITEM_HEIGH - LIST_1ICON_1STR_1LINE_TOP},
            WATCH_LISTITEM_NORMAL_FONT, WATCH_LISTITEM_NORMAL_FONT,
            0, 0
        },
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_1str_1line_radio_big_layout1 =
{
    LIST_1STR_1LINE_RADIO_BIG_ITEM_HEIGH, LIST_1STR_1LINE_RADIO_BIG_ITEM_HEIGH,

    {
        {
            0,
            { LIST_1STR_1LINE_RADIO_LEFT,  LIST_1STR_1LINE_RADIO_TOP,  LIST_1STR_1LINE_RADIO_LEFT + LIST_1STR_1LINE_RADIO_TEXT_WIDGH , LIST_1STR_1LINE_RADIO_BIG_ITEM_HEIGH - LIST_1STR_1LINE_RADIO_TOP},
            { LIST_1STR_1LINE_RADIO_LEFT,  LIST_1STR_1LINE_RADIO_TOP,  LIST_1STR_1LINE_RADIO_LEFT + LIST_1STR_1LINE_RADIO_TEXT_WIDGH , LIST_1STR_1LINE_RADIO_BIG_ITEM_HEIGH - LIST_1STR_1LINE_RADIO_TOP},
            WATCH_LISTITEM_NORMAL_FONT, WATCH_LISTITEM_NORMAL_FONT,
            0, 0
        },
    ...
    //|---------------------------|
    //GUIITEM_STYLE_1ICON_2STR,
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_1icon_2str_1line_layout =
{
    LIST_1ICON_1STR_1LINE_ITEM_HEIGH, LIST_1ICON_1STR_1LINE_ITEM_HEIGH,

    {
        ...
        {
            0,
            { LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH + LIST_1ICON_1STR_1LINE_ICON_AND_TEXT_OFFESET,  LIST_2STR_2LINE_TOP,  LIST_1ICON_1STR_1LINE_RIGHT,  LIST_2STR_2LINE_FIRST_LINE_HEIGH + LIST_2STR_2LINE_TOP},
            { LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH + LIST_1ICON_1STR_1LINE_ICON_AND_TEXT_OFFESET,  LIST_2STR_2LINE_TOP,  LIST_1ICON_1STR_1LINE_RIGHT,  LIST_2STR_2LINE_FIRST_LINE_HEIGH + LIST_2STR_2LINE_TOP},
            WATCH_LISTITEM_NORMAL_FONT, WATCH_LISTITEM_NORMAL_FONT,
            0, 0
        },
        {
            0,
            { LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH + LIST_1ICON_1STR_1LINE_ICON_AND_TEXT_OFFESET,  LIST_2STR_2LINE_FIRST_LINE_HEIGH + LIST_2STR_2LINE_TOP,  LIST_1ICON_1STR_1LINE_RIGHT,  LIST_1ICON_1STR_1LINE_ITEM_HEIGH - LIST_2STR_2LINE_TOP},
            { LIST_1ICON_1STR_1LINE_LEFT + LIST_1ICON_1STR_1LINE_ICON_HEIGH + LIST_1ICON_1STR_1LINE_ICON_AND_TEXT_OFFESET,  LIST_2STR_2LINE_FIRST_LINE_HEIGH + LIST_2STR_2LINE_TOP,  LIST_1ICON_1STR_1LINE_RIGHT,  LIST_1ICON_1STR_1LINE_ITEM_HEIGH - LIST_2STR_2LINE_TOP},
            WATCHLIST_ITEM_SMALL_FONT, WATCHLIST_ITEM_SMALL_FONT,
            0, 0
        },
...
LOCAL THEMELIST_ITEM_STYLE_T const dsl_english_book_item =
{
    2.5*WORD_CARD_LINE_HIGHT, 2.5*WORD_CARD_LINE_HIGHT,
    {
        ...
        {
            GUIITEM_CONTENT_STATE_NONE,
            {20,  0.6*WORD_CARD_LINE_HIGHT,  36, 1.8*WORD_CARD_LINE_HIGHT},
            {20,  0.6*WORD_CARD_LINE_HIGHT,  36, 1.8*WORD_CARD_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 100
        },
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_ms =
{
    2*ZMT_GPT_LIST_LINE_HIGHT, 2*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //icon
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, 2*ZMT_GPT_LINE_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            {ZMT_GPT_LINE_WIDTH, 0, 2*ZMT_GPT_LINE_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {2*ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            {2*ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_ms =
{
    2*ZMT_GPT_LIST_LINE_HIGHT, 2*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 2*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        {0},
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_2line_ms =
{
    4*ZMT_GPT_LIST_LINE_HIGHT+5, 4*ZMT_GPT_LIST_LINE_HIGHT+5,
    {
        //icon
        {
            0,
            {0, 0, ZMT_GPT_LINE_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            {0, 0, ZMT_GPT_LINE_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            0, 0
        }, 
        //text
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_2line_ms =
{
    4*ZMT_GPT_LIST_LINE_HIGHT+5, 4*ZMT_GPT_LIST_LINE_HIGHT+5,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 4*ZMT_GPT_LIST_LINE_HIGHT+5},
            0, 0
        }, 
        {0},
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_3line_ms =
{
    6*ZMT_GPT_LIST_LINE_HIGHT, 6*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //icon
        {
            0,
            {0, 0, ZMT_GPT_LINE_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, ZMT_GPT_LINE_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_3line_ms =
{
    6*ZMT_GPT_LIST_LINE_HIGHT, 6*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 6*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        {0},
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_4line_ms =
{
    8*ZMT_GPT_LIST_LINE_HIGHT, 8*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //icon
        {
            0,
            {0, 0, ZMT_GPT_LINE_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, ZMT_GPT_LINE_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_4line_ms =
{
    8*ZMT_GPT_LIST_LINE_HIGHT, 8*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 8*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        {0},
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_5line_ms =
{
    10*ZMT_GPT_LIST_LINE_HIGHT, 10*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //icon
        {
            0,
            {0, 0, ZMT_GPT_LINE_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, ZMT_GPT_LINE_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_5line_ms =
{
    10*ZMT_GPT_LIST_LINE_HIGHT, 10*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 10*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        {0},
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_6line_ms =
{
    12*ZMT_GPT_LIST_LINE_HIGHT, 12*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //icon
        {
            0,
            {0, 0, ZMT_GPT_LINE_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, ZMT_GPT_LINE_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_6line_ms =
{
    12*ZMT_GPT_LIST_LINE_HIGHT, 12*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 12*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        {0},
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_mine_7line_ms =
{
    14*ZMT_GPT_LIST_LINE_HIGHT, 14*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //icon
        {
            0,
            {0, 0, ZMT_GPT_LINE_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, ZMT_GPT_LINE_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            {ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },    
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_gpt_ai_7line_ms =
{
    14*ZMT_GPT_LIST_LINE_HIGHT, 14*ZMT_GPT_LIST_LINE_HIGHT,
    {
        //text
        {
            0,
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            {0, 0, MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },
        ...
        {
            0,
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            {MMI_MAINSCREEN_WIDTH-ZMT_GPT_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 14*ZMT_GPT_LIST_LINE_HIGHT},
            0, 0
        }, 
        {0},
...
//============================================================================//
	...
	{GUIITEM_STYLE_LF_ONE_LINE_BGICON_TEXT_MS, &s_item_style_lf_1_bgicon_text_ms}, 
	{GUIITEM_STYLE_LF_ONE_LINE_BGICON_R_TEXT_MS, &s_item_style_lf_2_bgicon_text_ms},
	{GUIITEM_STYLE_LF_TWO_LINE_BGICON_TEXT_MS, &s_item_style_lf2_1_bgicon_text_ms}, 
	{GUIITEM_STYLE_LF_TWO_LINE_BGICON_R_TEXT_MS, &s_item_style_lf2_2_bgicon_text_ms},
#endif
#ifdef ZTE_WATCH
    {GUIITEM_STYLE_1ICON_1STR_1LINE_WITH_UNREAD_NUM, &s_1icon_1str_1line_with_unread_num},
    {GUIITEM_STYLE_1ICON_1STR_1LINE_BIG_LAYOUT1, &s_1icon_1str_1line_big_layout1},
    {GUIITEM_STYLE_1STR_1LINE_BIG_LAYOUT1, &s_1str_1line_big_layout1},
    {GUIITEM_STYLE_1STR_1LINE_RADIO_BIG_LAYOUT1, &s_item_style_1str_1line_radio_big_layout1},
	...
	{GUIITEM_STYLE_1ICON_2STR_1LINE_LAYOUT, &s_item_style_1icon_2str_1line_layout},
#endif
#ifdef LISTENING_PRATICE_SUPPORT
    ...
    {GUIITEM_STYLE_GPT_MINE_TEXT_MS, &s_item_style_gpt_mine_ms},
    {GUIITEM_STYLE_GPT_AI_TEXT_MS, &s_item_style_gpt_ai_ms},
    {GUIITEM_STYLE_GPT_MINE_2LINE_TEXT_MS, &s_item_style_gpt_mine_2line_ms},
    {GUIITEM_STYLE_GPT_AI_2LINE_TEXT_MS, &s_item_style_gpt_ai_2line_ms},
    {GUIITEM_STYLE_GPT_MINE_3LINE_TEXT_MS, &s_item_style_gpt_mine_3line_ms},
    {GUIITEM_STYLE_GPT_AI_3LINE_TEXT_MS, &s_item_style_gpt_ai_3line_ms},
    {GUIITEM_STYLE_GPT_MINE_4LINE_TEXT_MS, &s_item_style_gpt_mine_4line_ms},
    {GUIITEM_STYLE_GPT_AI_4LINE_TEXT_MS, &s_item_style_gpt_ai_4line_ms},
    {GUIITEM_STYLE_GPT_MINE_5LINE_TEXT_MS, &s_item_style_gpt_mine_5line_ms},
    {GUIITEM_STYLE_GPT_AI_5LINE_TEXT_MS, &s_item_style_gpt_ai_5line_ms},
    {GUIITEM_STYLE_GPT_MINE_6LINE_TEXT_MS, &s_item_style_gpt_mine_6line_ms},
...
//  Note:
/*****************************************************************************/
PUBLIC GUI_BG_T WATCHTHEME_GetListItemBgEx(void)
{
    GUI_BG_T bg_info = {0};

    bg_info.bg_type = GUI_BG_IMG;
    bg_info.img_id  = image_watch_list_bg60;//image_watch_list_bg;
