...
//软件版本号
#define ZDT_CMCC_SFR_SW_VER 			"ZTE_ZW35V1.0.0B02"//"ZW206_K1_RDA_240X284_V01"
//自注册编码
...
#define ZDT_CMCC_SFR_MODEL 			"NM-ESC-A"
//软件版本号
#define ZDT_CMCC_SFR_SW_VER 			"ZTE_ZW22V1.0.0B02"//"ZW202_K1_ENTRY_RDA_240X240_V01"//"ZW202_K1_ENTRY_V01"//"NM-ESC-A_V2.3"
//硬件版本号
...
{
    "ZTE",   //MMISFR_CMCC_INDEX_BRAND
    "ZW35",   //MMISFR_CMCC_INDEX_MODEL
    ...
    "M100001047",     //MMISFR_CMCC_INDEX_APPKEY
    "04145Mk2u4KxlZ4qIADB9l0iR3118VLJ", //MMISFR_CMCC_INDEX_PASSWORD
...
char s_cmcc_device_info[MMISFR_CMCC_DEVICEINFO_INDEX_MAX][MMISFR_CMCC_STR_LEN + 1] =
{
    ...
    "240*284",     //SCREENSIZE,MMISFR_CMCC_DEVICEINFO_INDEX_SCREENSIZE
    ...
    "***",     //RESOLUTION,MMISFR_CMCC_DEVICEINFO_INDEX_RESOLUTION
