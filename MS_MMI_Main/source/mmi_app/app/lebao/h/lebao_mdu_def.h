...
RES_ADD_IMG(IMAGE_LEBAO_MENU_CONTACT, "\\MMI_RES_##\\IMAG\\menu_contact.png", IMG_CMP_PNG_ARGB_RLE, 0)
...
RES_ADD_IMG(IMAGE_LEBAO_ITEM_D4, "\\MMI_RES_##\\IMAG\\item_d4.png", IMG_CMP_PNG_ARGB_RLE, 0)
