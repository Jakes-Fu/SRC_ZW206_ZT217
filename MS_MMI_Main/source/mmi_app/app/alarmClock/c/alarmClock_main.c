...
LOCAL void AddAlarmAlertTitle(MMI_WIN_ID_T win_id)
{
	...
	GUI_RECT_T img_rect = DP2PX_RECT(0,45,239,85);
	GUI_RECT_T text_rect = DP2PX_RECT(0,45,239,85);
					...
					uint16 event_num )
{
	...
	if(0)
	{
		...
		GUISTR_STYLE_T text_style = {0};
		MMI_STRING_T text_title = {0};
		GUI_RECT_T add_rect = DP2PX_RECT(12, 240, 228, 280);
...
{	
	GUI_RECT_T clientRect = DP2PX_RECT(0,0,239,239);
	GUI_RECT_T win_rect = {0};
	GUI_RECT_T title_img_rect = {0};
	GUI_RECT_T title_rect = DP2PX_RECT(0,0,239,45);//{0,0,240,45}
	GUISTR_STATE_T text_state = GUISTR_STATE_ALIGN;
	GUISTR_STYLE_T text_style = {0};
	MMI_STRING_T text_title = {0};

	text_style.align = ALIGN_HVMIDDLE;//ALIGN_HMIDDLE;
	text_style.font = DP_FONT_22;//SONG_FONT_26;
