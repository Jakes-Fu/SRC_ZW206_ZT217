...
#define WATCH_MO_NAME_DISP_RECT             DP2PX_RECT(36, 80, 204, 108)
#define WATCH_MT_NAME_DISP_RECT             DP2PX_RECT(36, 108, 204, 128)
#define WATCH_CALL_STATE_DISP_RECT          DP2PX_RECT(36, 128, 204, 155)
#define WATCH_RECORD_STATE_DISP_RECT        P2PX_RECT(168,12,228,28)
#define WATCH_PULL_DOWN_START_POINT_LEFT     DP2PX_POINT(52,0)
#define WATCH_PULL_DOWN_START_POINT_RIGHT    DP2PX_POINT(164,0)
...
#define WATCH_RECORDING_BG_DISP_RECT        DP2PX_RECT(0,0,239,239)
#define WATCH_CALLING_TEXT_DISP_RECT        DP2PX_RECT(36, 24, 204, 40)

#define WATCH_STRING_FONT_BIG               DP_FONT_22
#else
#define WATCH_MO_PHOTO_START_POINT           DP2PX_POINT(84,16)
#define WATCH_MT_PHOTO_START_POINT           DP2PX_POINT(84,36)
#define WATCH_MO_QUERY_STR_DISP_RECT        DP2PX_RECT(12,0,228,152)
#define WATCH_MO_NAME_DISP_RECT             DP2PX_RECT(12,100,228,124)
#define WATCH_MT_NAME_DISP_RECT             DP2PX_RECT(12,124,228,148)
#define WATCH_CALL_STATE_DISP_RECT          DP2PX_RECT(12,148,228,170)
#define WATCH_RECORD_STATE_DISP_RECT        DP2PX_RECT(168,12,228,28)
#define WATCH_PULL_DOWN_START_POINT_LEFT    DP2PX_POINT(52,0)
#define WATCH_PULL_DOWN_START_POINT_RIGHT   DP2PX_POINT(164,0)
#define WATCH_SMS_REJECT_DISP_RECT          DP2PX_RECT(88,0,152,24)
#define WATCH_SMS_REJECT_TP_VAILD_RECT      DP2PX_RECT(52,0,188,24)
#define WATCH_CALL_TIME_DISP_RECT           DP2PX_RECT(12,136,228,152)
#define WATCH_RECORDING_BG_DISP_RECT        DP2PX_RECT(0,0,239,239)

#define WATCH_STRING_FONT_BIG               DP_FONT_30
#endif

#define WATCH_STRING_FONT_MIDDLE            DP_FONT_24
#define WATCH_STRING_FONT_SMALL             SONG_FONT_12
