...
#define word_auto_play_rect {4*WORD_CARD_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, WORD_CARD_LINE_HIGHT}
...
WINDOW_TABLE(MMI_WORD_LISTEN_INFO_WIN_TAB) = {
    ...
    CREATE_BUTTON_CTRL(ZMT_LISTEN_VOLUME, MMI_ZMT_WORD_LISTEN_INFO_BUTTON_AUDIO_CTRL_ID),//音频图标
