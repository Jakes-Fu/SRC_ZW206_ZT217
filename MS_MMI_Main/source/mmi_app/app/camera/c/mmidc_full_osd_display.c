...
//    {IMG_DC_WATCH_WAIT,         DP2PX_RECT( 96,  84, 143, 131)} //ICON_WAITING, not used now
   ...
   {res_common_set_cancel,       DP2PX_RECT( 12, 208,  116, 248)}, //ICON_DC_CANCEL,
   {res_common_set_confirm,      DP2PX_RECT(124, 208, 238, 255)}, //ICON_DC_CONFIRM,
...
//    {IMG_DC_WATCH_WAIT,         DP2PX_RECT( 96,  84, 143, 131)} //ICON_WAITING, not used now
    #elif defined(MAINLCD_DEV_SIZE_240X320)// wuxx add for CAMERA BF20A6,GC6133, 240X284 预览全屏, and isp_service.a
   //{IMG_DC_WATCH_OPEN_GALLERY, DP2PX_RECT( 40, 208,  87, 255)}, //ICON_OPEN_GALLERY,
    {IMG_DC_WATCH_OPEN_GALLERY, DP2PX_RECT( 40, 248,  87, 295)}, //ICON_OPEN_GALLERY,
   {IMG_DC_WATCH_CAPTURE_IMAGE,DP2PX_RECT( 96, 248, 143, 295)}, //ICON_CAPTURE_IMAGE,
   {IMG_DC_WATCH_START_RECORD, DP2PX_RECT( 96, 248, 143, 295)}, //ICON_RECORD_START,
   {IMG_DC_WATCH_STOP_RECORD,  DP2PX_RECT( 96, 248, 143, 295)}, //ICON_RECORD_STOP,
   {IMG_DC_WATCH_SWITCH_TO_DV, DP2PX_RECT(152, 248, 199, 295)}, //ICON_SWITCH_DV,
   {IMG_DC_WATCH_SWITCH_TO_DC, DP2PX_RECT(152, 248, 199, 295)}, //ICON_SWITCH_DC,
   {IMG_DC_WATCH_PLAY,         DP2PX_RECT( 96,  124, 143, 171)}, //ICON_DV_PLAY,
   {IMG_DC_WATCH_PAUSE_PLAY,   DP2PX_RECT( 96,  124, 143, 171)}, //ICON_DV_PAUSE,
   {res_common_set_cancel,       DP2PX_RECT( 12, 248,  116, 295)}, //ICON_DC_CANCEL,
   {res_common_set_confirm,      DP2PX_RECT(124, 248, 238, 295)}, //ICON_DC_CONFIRM,
   {IMG_DC_WATCH_CANCEL,       DP2PX_RECT( 60, 248,  107, 295)}, //ICON_DV_CANCEL,
   {IMG_DC_WATCH_CONFIRM_GRAY,      DP2PX_RECT(132, 208, 179, 295)}, //ICON_DV_CONFIRM,
//    {IMG_DC_WATCH_WAIT,         DP2PX_RECT( 96,  84, 143, 131)} //ICON_WAITING, not used now
    {IMG_DC_WATCH_SWITCH_CAMERA, DP2PX_RECT(152, 248, 199, 295)}, //ICON_SWITCH_CAMERA,
   #else
    ...
    {IMG_DC_WATCH_PLAY,         DP2PX_RECT( 96,  84, 143, 131)}, //ICON_DV_PLAY,
    {IMG_DC_WATCH_PAUSE_PLAY,   DP2PX_RECT( 96,  84, 143, 131)}, //ICON_DV_PAUSE,
    {res_common_set_cancel,       DP2PX_RECT( 12, 168,  116, 208)}, //ICON_DC_CANCEL,
    {res_common_set_confirm,      DP2PX_RECT(124, 168, 238, 208)}, //ICON_DC_CONFIRM,
    {IMG_DC_WATCH_CANCEL,       DP2PX_RECT( 60, 168,  107, 215)}, //ICON_DV_CANCEL,
...
DC_OSD_LAYOUT_T s_osd_layout_list[DC_FLOW_MODE_MAX] = {
    { {ICON_OPEN_GALLERY, ICON_CAPTURE_IMAGE, ICON_SWITCH_CAMERA, ICON_MAX }, 1, 1, TRUE , TRUE },//{ {ICON_OPEN_GALLERY, ICON_CAPTURE_IMAGE, ICON_SWITCH_DV, ICON_MAX }, 1, 1, TRUE , TRUE },//dc preview mode
