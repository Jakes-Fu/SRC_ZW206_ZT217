...
//    {IMG_DC_WATCH_WAIT,         DP2PX_RECT( 96,  84, 143, 131)} //ICON_WAITING, not used now
   ...
   //{IMG_DC_WATCH_OPEN_GALLERY, DP2PX_RECT( 40, 208,  87, 255)}, //ICON_OPEN_GALLERY,
    {IMG_DC_WATCH_OPEN_GALLERY, CAMERA_OPEN_GALLERY_RECT}, //ICON_OPEN_GALLERY,
   {IMG_DC_WATCH_CAPTURE_IMAGE,CAMERA_CAPTURE_IMAGE_RECT}, //ICON_CAPTURE_IMAGE,
...
//    {IMG_DC_WATCH_WAIT,         DP2PX_RECT( 96,  84, 143, 131)} //ICON_WAITING, not used now
    {IMG_DC_WATCH_SWITCH_CAMERA, CAMERA_SWITCH_CAMERA_RECT}, //ICON_SWITCH_CAMERA,
   #else
