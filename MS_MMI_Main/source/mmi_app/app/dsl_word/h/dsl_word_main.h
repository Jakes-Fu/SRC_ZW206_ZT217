...
#ifndef _DSL_WORD_MAIN_H_
#define _DSL_WORD_MAIN_H_
#include "sci_types.h"
#include "mmk_type.h"
...
//PUBLIC void MMIREADBOY_HomeworkCreateWordWin(DSL_HOMEWORK_TASK_T * info);
//PUBLIC void MMIREADBOY_TeacherWordTask(char * msg_id);
/*----------------------------------------------------------------------------*/
/* Compiler Flag */
/*----------------------------------------------------------------------------*/
#ifdef _cplusplus
