...
#define MMIENVSET_TKEY_RING_VOL_BLUETOOTH_MODE      MMISET_VOL_SIX
    // --------------------------------------------------开关机音量-------------------------------------------------------------
    // 普通环境
#define MMIENVSET_POWER_RING_VOL_STANDARD_MODE      MMISET_VOL_THREE
    // 安静环境 
...
//#define MMIENVSET_POWER_RING_VOL_FLY_MODE           MMISET_VOL_THREE
    ...
    // ----------------------------------------------来电提示类型----------------------------------------------------------------
    // 普通环境
#define MMIENVSET_CALL_RING_TYPE_STANDARD_MODE      MMISET_CALL_RING//MMISET_CALL_VIBRA_AND_RING //默认来电响铃
    // 安静环境
