...
LOCAL void ScreenShot(MMI_WIN_ID_T win_id, GUI_LCD_DEV_INFO *dev)
{
    ...
    rect.right  = (int16)(SLIDE_PAGE_WIDTH - 1);
    rect.bottom = (int16)(SLIDE_PAGE_HEIGHT - 1);
...
PUBLIC uint8 WatchSLIDEAGE_getCurrentPageIndex()
{
    ...
    if (entity == NULL)
    {
        TRACE_APP_SLIDEPAGE("WatchSLIDEAGE_getCurrentPageIndex entity == NULL");
        return 0;
    }
    return entity->cur_page_index;
}
