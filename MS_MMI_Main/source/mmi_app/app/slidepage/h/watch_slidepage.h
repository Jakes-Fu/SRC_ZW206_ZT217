...
#define SLIDE_CHANGE_PAGE_THR DP2PX_VALUE(2) //30

#define SLIDE_CHANGE_PAGE_Y_OFFSET  DP2PX_VALUE(50)

/*the animation interval of slidepage*/
#define SLIDE_PAGE_TPDRAP_INTERVAL 20 //25

/*the thres of horzional slide startup*/
#define SLIDE_PAGE_TPDRAP_THRES DP2PX_VALUE(2)

/*the step value of slide animation*/
#define SLIDE_PAGE_AUTOSLIDE_THRES DP2PX_VALUE(240)


#define SLIDE_PAGE_AUTO_FRAMENUM 25 //10
