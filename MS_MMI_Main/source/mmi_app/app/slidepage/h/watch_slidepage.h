...
#define SLIDE_PAGE_WIDTH (MMI_MAINSCREEN_WIDTH)

#define SLIDE_PAGE_HEIGHT (MMI_MAINSCREEN_HEIGHT)
...
#define SLIDE_PAGE_TPDRAP_THRES DP2PX_VALUE(15)
...
#define SLIDEPAGE_UPDATE_RECT {0,0,MMI_MAINSCREEN_WIDTH,MMI_MAINSCREEN_HEIGHT}
...
typedef void (*PFUN_WatchSlidePageItemWin_Enter)(MMI_WIN_ID_T win_id);
...
PUBLIC uint8 WatchSLIDEAGE_getCurrentPageIndex();
