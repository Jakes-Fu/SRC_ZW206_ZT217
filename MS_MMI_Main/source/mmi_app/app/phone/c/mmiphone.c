...
const GUI_RECT_T SHUTDOWN_SOS_BG_RECT = DP2PX_RECT(40, 30+60+60, 40+160, 240-30);
const GUI_RECT_T SHUTDOWN_SOS_BG_TEXT_RECT = DP2PX_RECT(116, 170, 96+88, 190);
const GUI_RECT_T SHUTDOWN_SOS_BTN_RECT = DP2PX_RECT(40, 162, 92, 198);
#else
