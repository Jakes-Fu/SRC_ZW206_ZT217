                                     ...
                                     )
{
    ...
    case CHR_MSG_CHARGE_FAULT_OVERTEMP_IND:
        ...
        case CHR_MSG_CHARGE_LOW_TEMPTURE_IND:
        case CHR_MSG_CHARGE_HOT_TEMPTURE_IND:
            result = MMIPHONE_ChargeHandlePsAndRefMsg(app_ptr,msg_id,param);
            break;
#endif
...
#ifdef ADULT_WATCH_SUPPORT
const GUI_RECT_T ADULT_SHUTDOWN_EMERG_ICON_RECT = DP2PX_RECT(56, 39, 56+32, 39+48);
const GUI_RECT_T ADULT_SHUTDOWN_EMERG_TEXT_RECT = DP2PX_RECT(88, 39, 88+120, 39+48);
const GUI_RECT_T ADULT_SHUTDOWN_RESET_BTN_RECT = DP2PX_RECT(48, 111, 48+48+2, 111+48);
const GUI_RECT_T ADULT_SHUTDOWN_OFF_BTN_RECT = DP2PX_RECT(144, 111, 144+48+2, 111+48);
const GUI_RECT_T ADULT_SHUTDOWN_CANCEL_TEXT_RECT = DP2PX_RECT(36, 183, 36+168, 183+48);
#endif
#ifdef SCREEN_SHAPE_CIRCULAR
const GUI_RECT_T SHUTDOWN_OFF_BG_RECT = DP2PX_RECT(40, 70, 40+160, 70+60);
const GUI_RECT_T SHUTDOWN_OFF_BG_TEXT_RECT = DP2PX_RECT(96, 90, 96+88, 110);
const GUI_RECT_T SHUTDOWN_OFF_BTN_RECT = DP2PX_RECT(56, 82, 92, 118);
const GUI_RECT_T SHUTDOWN_RESET_BG_RECT = DP2PX_RECT(40, 70+60, 40+160, 70+60+60);
const GUI_RECT_T SHUTDOWN_RESET_BG_TEXT_RECT = DP2PX_RECT(96, 150, 96+88, 170);
const GUI_RECT_T SHUTDOWN_RESET_BTN_RECT = DP2PX_RECT(56, 142, 92, 178);
const GUI_RECT_T SHUTDOWN_FLYMODE_BG_RECT = DP2PX_RECT(40, 70+60+60, 40+160, 280-30);
const GUI_RECT_T SHUTDOWN_FLYMODE_BG_TEXT_RECT = DP2PX_RECT(96, 210, 96+88, 230);
const GUI_RECT_T SHUTDOWN_FLYMODE_BTN_RECT = DP2PX_RECT(56, 202, 92, 238);

const GUI_RECT_T SHUTDOWN_SOS_BG_RECT = DP2PX_RECT(40, 70+60+60, 40+160, 280-30);
const GUI_RECT_T SHUTDOWN_SOS_BG_TEXT_RECT = DP2PX_RECT(116, 210, 96+88, 230);
const GUI_RECT_T SHUTDOWN_SOS_BTN_RECT = DP2PX_RECT(40, 202, 92, 238);
#else
const GUI_RECT_T SHUTDOWN_OFF_BG_RECT = DP2PX_RECT(28, 66, 28+184, 66+64);
const GUI_RECT_T SHUTDOWN_OFF_BG_TEXT_RECT = DP2PX_RECT(40, 66, 40+184, 66+64);
const GUI_RECT_T SHUTDOWN_OFF_BTN_RECT =  DP2PX_RECT(28, 66, 28+64+2, 66+64);
const GUI_RECT_T SHUTDOWN_RESET_BTN_RECT =  DP2PX_RECT(28, 170, 28+64+2, 170+64);
const GUI_RECT_T SHUTDOWN_FLYMODE_BTN_RECT =  DP2PX_RECT(148, 170, 148+64+2, 170+64);
#endif
