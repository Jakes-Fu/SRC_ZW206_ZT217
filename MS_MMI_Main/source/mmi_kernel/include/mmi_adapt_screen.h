...
#include "mmk_type.h"
#if  1 //def ADAPT_SCREEN_ENABLE
//only support basedp == 240*240 now-- 2021.01.09
#if 1 //def DP_SCREEN_SIZE_240X240


    #if 0//PROJECT_SCREEN_SIZE_240X240
		#define DP2PX_K 1
		#define PX2DP_K 1
    #elif 0//defined(PROJECT_SCREEN_SIZE_320X320)
        #define DP2PX_K 1.3333333
        #define PX2DP_K 0.75
    #elif 0//defined(PROJECT_SCREEN_SIZE_360X360)
        #define DP2PX_K 1.5
        #define PX2DP_K 0.6666667
    #elif 0//defined(PROJECT_SCREEN_SIZE_400X400)
        #define DP2PX_K 1.6666667
        #define PX2DP_K 0.6
    #elif 0//defined(PROJECT_SCREEN_SIZE_128X160)
        #define DP2PX_K 0.533333
        #define PX2DP_K 1.875
#elif 1 //defined(PROJECT_SCREEN_SIZE_128X128)

    #define DP2PX_K 0.533333
    #define PX2DP_K 1.875
    #define DP2PX_Y 0.533333
...
#define  DP2PX_VALUE_Y(y)                                (ROUND(DP2PX_Y * (y))) //DP to Pixel for value
#define  DP2PX_POINT(x, y)                            {DP2PX_VALUE(x), DP2PX_VALUE_Y(y)} //DP to Pixel for point
#define  DP2PX_RECT(left, top, right, bottom) {DP2PX_VALUE(left), DP2PX_VALUE_Y(top), DP2PX_VALUE(right), DP2PX_VALUE_Y(bottom)} //DP to Pixel for rect
