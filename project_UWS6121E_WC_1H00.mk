...
#
# 本文件是展锐配置文件
# 自定义的宏请到 feature_config_gnss.cfg 文件中添加
#
#****************************************
include feature_config_gnss.cfg
#debug 版本配置
include app_config_debug.cfg
...
RF_BAND_SELFADAPTIVE = FALSE                    		### OPEN/CLOSE RF BAND SELFADAPTIVE FUNCTION
													# Option0:TRUE     
													# Option1:FALSE 
CHGMNG_PSE_SUPPORT = TRUE                    		### OPEN/CLOSE CHGMNG_PSE_SUPPORT
													# Option0:TRUE     
